...
{
	/// <summary>
	/// Descripción breve de ConsultaVentasController.
	/// </summary>
	public class ConsultaVentasController : IObserver,ITaskController
	{
		public ConsultaVentasController(ConsultaVentas brClass)
		{
			_brClass = brClass;	
			Init();
		}
		...
		private void Init()
		{
			...
			_contenedoresVisibles = Variables.GetValueString(Proceso, Tarea, "ContenedoresHabilitados");
			_contenedoresHabilitados = Variables.GetValueString(Proceso, Tarea, "ContenedoresVisibles");
		...
		{			
			get { return _brClass.ListaFamiliaDeComprobantesDV ; }			
		}				
		...
		private ConsultaVentas _brClass;
        ...
        {
            return _brClass.VisualizaBotonImprimirTicketDeCambio(IdTipoDeComprobante);
        }

        public bool ImprimirTicketDeCambio(string IdComprobante)
        {
            return _brClass.ImprimirTicketDeCambio(IdComprobante);
        }
