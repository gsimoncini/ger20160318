namespace mz.erp.businessrules 
{
	...
	public class tsh_ProductosJerarquias : IDisposable
	{
		...
		/// <summary>
		/// Obtiene la lista completa de la tabla tsh_ProductosJerarquias
		/// </summary>
		public static tsh_ProductosJerarquiasDataset GetList()
		{
			return mz.erp.dataaccess.tsh_ProductosJerarquias.GetList();
		}
		
		/// <summary>
		/// Obtiene tabla tsh_ProductosJerarquias filtrada por las condiciones de bsqueda
		/// </summary>
		/*public static tsh_ProductosJerarquiasDataset GetList(  )
		{
			return mz.erp.dataaccess.tsh_ProductosJerarquias.GetList(  );
		...
		/// <summary>
		/// Crea un tsh_ProductosJerarquiasRow que luego puede ser persistido en la base de datos.
		/// </summary>
		[ atMethodNewRow ]
		public static tsh_ProductosJerarquiasDataset.tsh_ProductosJerarquiasRow NewRow()
		{
			return SetRowDefaultValues(mz.erp.dataaccess.tsh_ProductosJerarquias.NewRow());
		}

		/// <summary>
		/// Obtiene un registro de la tabla tsh_ProductosJerarquias que luego puede ser persistido en la base de datos.
		/// </summary>
		public static tsh_ProductosJerarquiasDataset.tsh_ProductosJerarquiasRow GetByPk( string IdProducto )
		{ 
			tsh_ProductosJerarquiasDataset.tsh_ProductosJerarquiasRow row = mz.erp.dataaccess.tsh_ProductosJerarquias.GetByPk( IdProducto  );
			if (row !=null)
			{
		...
		/// <summary>
		/// Obtiene un registro de la tabla tsh_ProductosJerarquias que luego puede ser persistido en la base de datos. Metodo Sobrecargado
		/// </summary>
		[ atMethodGetByPkRow ]
		public static tsh_ProductosJerarquiasDataset.tsh_ProductosJerarquiasRow GetByPk( object IdProducto )
		{
			return GetByPk( ( string )IdProducto );
		}

		/// <summary>
		/// Establece los valores por defecto de tsh_ProductosJerarquiasRow.
		/// </summary>
		public static tsh_ProductosJerarquiasDataset.tsh_ProductosJerarquiasRow SetRowDefaultValues( tsh_ProductosJerarquiasDataset.tsh_ProductosJerarquiasRow row )
		{
			...
			//row.UltimaModificacion = System.DBNull.Value;
		...
		/// <summary>
		/// Envia los cambios del tsh_ProductosJerarquiasRow a la base de datos realizando una validacin previa.
		/// </summary>
		[ atMethodSaveRowWithValidation ]
		public static void UpdateWithValidation( tsh_ProductosJerarquiasDataset.tsh_ProductosJerarquiasRow row )
		{
		...
		/// <summary>
		/// Envia los cambios del tsh_ProductosJerarquiasRow a la base de datos realizando una validacin previa. Mtodo Sobrecargado
		/// </summary>
		public static void UpdateWithValidation( System.Data.DataRow row )
		{
			UpdateWithValidation( ( tsh_ProductosJerarquiasDataset.tsh_ProductosJerarquiasRow )row );
		}
		
		/// <summary>
		/// Envia los cambios del tsh_ProductosJerarquiasRow a la base de datos.
		/// </summary>
		public static void Update( tsh_ProductosJerarquiasDataset.tsh_ProductosJerarquiasRow row )
		{
			ApplicationAssert.Check( row != null, "El argumento row no debe ser nulo.", ApplicationAssert.LineNumber );
			
			mz.erp.dataaccess.tsh_ProductosJerarquias.Update( row );
		}

		/// <summary>
		/// Envia los cambios del tsh_ProductosJerarquiasDataset a la base de datos.
		/// </summary>
		public static void Update( tsh_ProductosJerarquiasDataset dataSet )
		{
			ApplicationAssert.Check( dataSet != null, "El argumento dataSet no debe ser nulo.", ApplicationAssert.LineNumber );
			ApplicationAssert.Check( dataSet.tsh_ProductosJerarquias.Rows.Count > 0, "La tabla dataSet.tsh_ProductosJerarquiasDataTable debe poseer alguna fila.", ApplicationAssert.LineNumber );
			
			mz.erp.dataaccess.tsh_ProductosJerarquias.Update( dataSet );
		}
		
		/// <summary>
		/// Envia los cambios del tsh_ProductosJerarquiasDataset.tsh_ProductosJerarquiasDataTable a la base de datos.
		/// </summary>
		public static void Update( tsh_ProductosJerarquiasDataset.tsh_ProductosJerarquiasDataTable dataTable )
		{
			ApplicationAssert.Check( dataTable != null, "El argumento dataTable no debe ser nulo.", ApplicationAssert.LineNumber );
			ApplicationAssert.Check( dataTable.Rows.Count > 0, "El argumento dataTable debe poseer alguna fila.", ApplicationAssert.LineNumber );
			
			mz.erp.dataaccess.tsh_ProductosJerarquias.Update( dataTable );
		}
		
		/// <summary>
		/// Valida un tsh_ProductosJerarquiasRow.
		/// </summary>
		public static bool RowIsValid( tsh_ProductosJerarquiasDataset.tsh_ProductosJerarquiasRow row )
		{
			ApplicationAssert.Check( row != null, "El argumento row no debe ser nulo.", ApplicationAssert.LineNumber );
			bool isValid=true;
			string mensaje;
