...
namespace mz.erp.businessrules 
{
	...
	public class tpu_ProveedoresJerarquias : IDisposable
	{
		...
		/// <summary>
		/// Obtiene un registro de la tabla tpu_ProveedoresJerarquias que luego puede ser persistido en la base de datos. Metodo Sobrecargado
		/// </summary>
		[ atMethodGetByPkRow ]
		public static tpu_ProveedoresJerarquiasDataset.tpu_ProveedoresJerarquiasRow GetByPk( object IdProveedor )
		{
			return GetByPk( ( string )IdProveedor );
		}

		/// <summary>
		/// Establece los valores por defecto de tpu_ProveedoresJerarquiasRow.
		/// </summary>
		public static tpu_ProveedoresJerarquiasDataset.tpu_ProveedoresJerarquiasRow SetRowDefaultValues( tpu_ProveedoresJerarquiasDataset.tpu_ProveedoresJerarquiasRow row )
		{
		...
		/// <summary>
		/// Envia los cambios del tpu_ProveedoresJerarquiasRow a la base de datos realizando una validacin previa.
		/// </summary>
		[ atMethodSaveRowWithValidation ]
		public static void UpdateWithValidation( tpu_ProveedoresJerarquiasDataset.tpu_ProveedoresJerarquiasRow row )
		{
		...
		/// <summary>
		/// Envia los cambios del tpu_ProveedoresJerarquiasRow a la base de datos realizando una validacin previa. Mtodo Sobrecargado
		/// </summary>
		public static void UpdateWithValidation( System.Data.DataRow row )
		{
			UpdateWithValidation( ( tpu_ProveedoresJerarquiasDataset.tpu_ProveedoresJerarquiasRow )row );
		}
		
		/// <summary>
		/// Envia los cambios del tpu_ProveedoresJerarquiasRow a la base de datos.
		/// </summary>
		public static void Update( tpu_ProveedoresJerarquiasDataset.tpu_ProveedoresJerarquiasRow row )
		{
			//ApplicationAssert.Check( row != null, "El argumento row no debe ser nulo.", ApplicationAssert.LineNumber );
			
			mz.erp.dataaccess.tpu_ProveedoresJerarquias.Update( row );
		}

		/// <summary>
		/// Envia los cambios del tpu_ProveedoresJerarquiasDataset a la base de datos.
		/// </summary>
		public static void Update( tpu_ProveedoresJerarquiasDataset dataSet )
		{
			//ApplicationAssert.Check( dataSet != null, "El argumento dataSet no debe ser nulo.", ApplicationAssert.LineNumber );
			//ApplicationAssert.Check( dataSet.tpu_ProveedoresJerarquias.Rows.Count > 0, "La tabla dataSet.tpu_ProveedoresJerarquiasDataTable debe poseer alguna fila.", ApplicationAssert.LineNumber );
			
			mz.erp.dataaccess.tpu_ProveedoresJerarquias.Update( dataSet );
		}
		
		/// <summary>
		/// Envia los cambios del tpu_ProveedoresJerarquiasDataset.tpu_ProveedoresJerarquiasDataTable a la base de datos.
		/// </summary>
		public static void Update( tpu_ProveedoresJerarquiasDataset.tpu_ProveedoresJerarquiasDataTable dataTable )
		{
			//ApplicationAssert.Check( dataTable != null, "El argumento dataTable no debe ser nulo.", ApplicationAssert.LineNumber );
			//ApplicationAssert.Check( dataTable.Rows.Count > 0, "El argumento dataTable debe poseer alguna fila.", ApplicationAssert.LineNumber );
			
			mz.erp.dataaccess.tpu_ProveedoresJerarquias.Update( dataTable );
		}
		
		/// <summary>
		/// Valida un tpu_ProveedoresJerarquiasRow.
		/// </summary>
		public static bool RowIsValid( tpu_ProveedoresJerarquiasDataset.tpu_ProveedoresJerarquiasRow row )
		{
			ApplicationAssert.Check( row != null, "El argumento row no debe ser nulo.", ApplicationAssert.LineNumber );
			bool isValid=true;
			string mensaje;
