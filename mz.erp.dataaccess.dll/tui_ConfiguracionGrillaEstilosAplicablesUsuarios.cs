namespace mz.erp.dataaccess 
{
	...
	public class tui_ConfiguracionGrillaEstilosAplicablesUsuarios : IDisposable
	{
		...
		{
			tui_ConfiguracionGrillaEstilosAplicablesUsuariosDataset data = new tui_ConfiguracionGrillaEstilosAplicablesUsuariosDataset();

			return ( tui_ConfiguracionGrillaEstilosAplicablesUsuariosDataset )GetList( data );
		}

		public static DataSet GetList( DataSet data )
		{
			SqlDataAdapter adapter = new SqlDataAdapter();
			adapter.TableMappings.Add( "Table", "tui_ConfiguracionGrillaEstilosAplicablesUsuarios" );
			
			SqlCommand cmd = new SqlCommand( "Pr_tui_ConfiguracionGrillaEstilosAplicablesUsuarios_GetList", dbhelper.Connection.GetConnection() );
		...
		public static tui_ConfiguracionGrillaEstilosAplicablesUsuariosDataset GetList( long IdProceso, long IdTarea, string Grilla, string Formulario, string IdUsuario, long IdConfiguracion, DateTime FechaCreacion, long IdEmpresa, long IdSucursal )
		{
			...
			SqlCommand cmd = new SqlCommand( "Pr_tui_ConfiguracionGrillaEstilosAplicablesUsuarios_Search", dbhelper.Connection.GetConnection() );
			cmd.CommandType = CommandType.StoredProcedure;
		...
		{
			return ( new tui_ConfiguracionGrillaEstilosAplicablesUsuariosDataset() ).tui_ConfiguracionGrillaEstilosAplicablesUsuarios.Newtui_ConfiguracionGrillaEstilosAplicablesUsuariosRow();
		}
		...
		public static tui_ConfiguracionGrillaEstilosAplicablesUsuariosDataset.tui_ConfiguracionGrillaEstilosAplicablesUsuariosRow GetByPk( long IdProceso, long IdTarea, string Grilla, string IdUsuario, long IdConfiguracion )
		{
			...
			SqlCommand cmd = new SqlCommand( "Pr_tui_ConfiguracionGrillaEstilosAplicablesUsuarios_GetByPk", dbhelper.Connection.GetConnection()  );
			cmd.CommandType = CommandType.StoredProcedure;
			...
			if ( data.tui_ConfiguracionGrillaEstilosAplicablesUsuarios.Rows.Count == 1 )
			{
				return ( tui_ConfiguracionGrillaEstilosAplicablesUsuariosDataset.tui_ConfiguracionGrillaEstilosAplicablesUsuariosRow )data.tui_ConfiguracionGrillaEstilosAplicablesUsuarios.Rows[ 0 ];
			}
		...
		public static void Update( tui_ConfiguracionGrillaEstilosAplicablesUsuariosDataset.tui_ConfiguracionGrillaEstilosAplicablesUsuariosRow row )
		{
			...
			{
				( ( tui_ConfiguracionGrillaEstilosAplicablesUsuariosDataset.tui_ConfiguracionGrillaEstilosAplicablesUsuariosDataTable )row.Table ).Addtui_ConfiguracionGrillaEstilosAplicablesUsuariosRow( row );
			}
		...
		{
			Update( dataSet.tui_ConfiguracionGrillaEstilosAplicablesUsuarios );
		}
		...
		public static void Update( DataTable dataTable )
		{
			...
			try
			{
				Update( ( tui_ConfiguracionGrillaEstilosAplicablesUsuariosDataset.tui_ConfiguracionGrillaEstilosAplicablesUsuariosDataTable )dataTable, trx );
				trx.Commit();
			}
			catch
			{
		...
		public static void Update( DataTable dataTable, SqlTransaction trx, SentenciasReplicacion replicacion )
		{
			...
			adapter.TableMappings.AddRange(
				new System.Data.Common.DataTableMapping[] {
															  new System.Data.Common.DataTableMapping( "Table", "tui_ConfiguracionGrillaEstilosAplicablesUsuarios", 
			...
			SqlCommand sqlCommandUpdate = new SqlCommand( "Pr_tui_ConfiguracionGrillaEstilosAplicablesUsuarios_Update", trx.Connection );
			...
			SqlCommand sqlCommandDelete = new SqlCommand( "Pr_tui_ConfiguracionGrillaEstilosAplicablesUsuarios_Delete", trx.Connection );
			...
			SqlCommand sqlCommandInsert = new SqlCommand("Pr_tui_ConfiguracionGrillaEstilosAplicablesUsuarios_Insert", trx.Connection );
