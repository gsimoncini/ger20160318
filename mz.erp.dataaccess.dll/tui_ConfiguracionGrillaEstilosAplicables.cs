namespace mz.erp.dataaccess 
{
	...
	public class tui_ConfiguracionGrillaEstilosAplicables : IDisposable
	{
		...
		{
			tui_ConfiguracionGrillaEstilosAplicablesDataset data = new tui_ConfiguracionGrillaEstilosAplicablesDataset();

			return ( tui_ConfiguracionGrillaEstilosAplicablesDataset )GetList( data );
		}

		public static DataSet GetList( DataSet data )
		{
			SqlDataAdapter adapter = new SqlDataAdapter();
			adapter.TableMappings.Add( "Table", "tui_ConfiguracionGrillaEstilosAplicables" );
			
			SqlCommand cmd = new SqlCommand( "Pr_tui_ConfiguracionGrillaEstilosAplicables_GetList", dbhelper.Connection.GetConnection() );
		...
		public static tui_ConfiguracionGrillaEstilosAplicablesDataset GetList( long IdProceso, long IdTarea, string Grilla, string Formulario, long IdConfiguracion, DateTime FechaCreacion, long IdEmpresa, long IdSucursal )
		{
			...
			SqlCommand cmd = new SqlCommand( "Pr_tui_ConfiguracionGrillaEstilosAplicables_Search", dbhelper.Connection.GetConnection() );
			cmd.CommandType = CommandType.StoredProcedure;
		...
		{
			return ( new tui_ConfiguracionGrillaEstilosAplicablesDataset() ).tui_ConfiguracionGrillaEstilosAplicables.Newtui_ConfiguracionGrillaEstilosAplicablesRow();
		}
		...
		public static tui_ConfiguracionGrillaEstilosAplicablesDataset.tui_ConfiguracionGrillaEstilosAplicablesRow GetByPk( long IdProceso, long IdTarea, string Grilla, long IdConfiguracion )
		{
			...
			SqlCommand cmd = new SqlCommand( "Pr_tui_ConfiguracionGrillaEstilosAplicables_GetByPk", dbhelper.Connection.GetConnection()  );
			cmd.CommandType = CommandType.StoredProcedure;
			...
			if ( data.tui_ConfiguracionGrillaEstilosAplicables.Rows.Count == 1 )
			{
				return ( tui_ConfiguracionGrillaEstilosAplicablesDataset.tui_ConfiguracionGrillaEstilosAplicablesRow )data.tui_ConfiguracionGrillaEstilosAplicables.Rows[ 0 ];
			}
		...
		public static void Update( tui_ConfiguracionGrillaEstilosAplicablesDataset.tui_ConfiguracionGrillaEstilosAplicablesRow row )
		{
			...
			{
				( ( tui_ConfiguracionGrillaEstilosAplicablesDataset.tui_ConfiguracionGrillaEstilosAplicablesDataTable )row.Table ).Addtui_ConfiguracionGrillaEstilosAplicablesRow( row );
			}
		...
		{
			Update( dataSet.tui_ConfiguracionGrillaEstilosAplicables );
		}
		...
		public static void Update( DataTable dataTable )
		{
			...
			try
			{
				Update( ( tui_ConfiguracionGrillaEstilosAplicablesDataset.tui_ConfiguracionGrillaEstilosAplicablesDataTable )dataTable, trx );
				trx.Commit();
			}
			catch
			{
		...
		public static void Update( DataTable dataTable, SqlTransaction trx, SentenciasReplicacion replicacion )
		{
			...
			adapter.TableMappings.AddRange(
				new System.Data.Common.DataTableMapping[] {
															  new System.Data.Common.DataTableMapping( "Table", "tui_ConfiguracionGrillaEstilosAplicables", 
			...
			SqlCommand sqlCommandUpdate = new SqlCommand( "Pr_tui_ConfiguracionGrillaEstilosAplicables_Update", trx.Connection );
			...
			SqlCommand sqlCommandDelete = new SqlCommand( "Pr_tui_ConfiguracionGrillaEstilosAplicables_Delete", trx.Connection );
			...
			SqlCommand sqlCommandInsert = new SqlCommand("Pr_tui_ConfiguracionGrillaEstilosAplicables_Insert", trx.Connection );
