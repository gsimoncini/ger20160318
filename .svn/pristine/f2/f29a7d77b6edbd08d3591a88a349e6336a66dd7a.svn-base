...
namespace mz.erp.commontypes.data {
    ...
    public class UsuariosExDataset : DataSet {
        
        private UsuariosDataTable tableUsuarios;
        
        public UsuariosExDataset() {
            this.InitClass();
        ...
        protected UsuariosExDataset(SerializationInfo info, StreamingContext context) {
        ...
        public override DataSet Clone() {
            UsuariosExDataset cln = ((UsuariosExDataset)(base.Clone()));
            cln.InitVars();
            return cln;
        }
        ...
        private void InitClass() {
            this.DataSetName = "UsuariosExDataset";
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/UsuariosExDataset.xsd";
        ...
        public class UsuariosDataTable : DataTable, System.Collections.IEnumerable {
            ...
            private void InitClass() {
                ...
                this.Constraints.Add(new UniqueConstraint("UsuariosExDatasetKey1", new DataColumn[] {
