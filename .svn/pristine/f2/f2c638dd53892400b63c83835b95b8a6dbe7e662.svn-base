...
namespace mz.erp.ui.reportes
{
	...
	public class rep_ListadoDeAjustesDeStock
	{
		...
		public static System.Data.DataSet GetList( DateTime FechaDesde, DateTime FechaHasta , string Persona, string Producto, string TipoDeAjuste)
		{			
			return mz.erp.businessrules.reportes.rep_ListadoDeAjustesDeStock.GetList( FechaDesde, FechaHasta, Persona, Producto, TipoDeAjuste, Security.IdEmpresa, Security.IdSucursal);
		}
		...
		public static string GetLayout()
		{
			...
			if ( fl.Contains( "Observaciones" ) || _fieldList == null ) sb.Append( LayoutBuilder.GetRow( i++, "Observaciones", "Observaciones",200) );
			if ( fl.Contains( "Usuario" ) || _fieldList == null ) sb.Append( LayoutBuilder.GetRow( i++, "Usuario", "Usuario",false) );
			if ( fl.Contains( "FechaCreacion" ) || _fieldList == null ) sb.Append( LayoutBuilder.GetRow( i++, "FechaCreacion", "Fecha Creación",false) );
