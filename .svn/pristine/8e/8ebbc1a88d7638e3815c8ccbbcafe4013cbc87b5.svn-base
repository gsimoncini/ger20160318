namespace mz.erp.businessrules 
{
	...
	public class tlg_Depositos : IDisposable
	{
		...
		public static tlg_DepositosDataset.tlg_DepositosRow SetRowDefaultValues( tlg_DepositosDataset.tlg_DepositosRow row )
		{
			...
			row.OldIdDeposito = string.Empty;
		...
		public static bool RowIsValid( tlg_DepositosDataset.tlg_DepositosRow row )
		{
			...
			if ( !OldIdDepositoIsValid( row.OldIdDeposito, out mensaje) )
			{ 
				row.SetColumnError( "OldIdDeposito" , mensaje);
				isValid=false;
		...
		/// </summary>
		public static bool ActivoIsValid( long Activo , out string mensaje )
		{
			//Agregar cdigo de validacin
			mensaje="";
			return true;
		...
		/// </summary>
		public static bool ActivoIsValid( long Activo)
		{
			string mensaje;
		...
		/// <summary>
		/// Valida el campo OldIdDeposito.
		/// </summary>
		public static bool OldIdDepositoIsValid( string OldIdDeposito , out string mensaje )
		{
			//Agregar cdigo de validacin
			mensaje="";
			return true;
		...
		/// <summary>
		/// Valida el campo OldIdDeposito. Metodo Sobrecargado
		/// </summary>
		public static bool OldIdDepositoIsValid( string OldIdDeposito)
		{
			string mensaje;
			return OldIdDepositoIsValid( OldIdDeposito, out mensaje );
		}		
