namespace mz.erp.ui
{
	...
	public class tsy_TiposAgrupamiento : IDisposable, IGridDocument
	{
		...
		public string GetLayout()
		{
			...
			returnValue += @"<Column0 ID=""IdTipoAgrup""><Caption>IdTipoAgrup</Caption><DataMember>IdTipoAgrup</DataMember><Key>IdTipoAgrup</Key><Position>0</Position></Column0>";
			...
			returnValue += @"<Column2 ID=""Categoria""><Caption>Categoria</Caption><DataMember>Categoria</DataMember><Key>Categoria</Key><Position>2</Position></Column2>";
			returnValue += @"<Column3 ID=""Estilo""><Caption>Estilo</Caption><DataMember>Estilo</DataMember><Key>Estilo</Key><Position>3</Position></Column3>";
		...
		{
			return mz.erp.businessrules.tsy_TiposAgrupamiento.GetList().tsy_TiposAgrupamiento;
		}
		
		public void Update( object dataTable )
		{
			mz.erp.businessrules.tsy_TiposAgrupamiento.Update( ( tsy_TiposAgrupamientoDataset.tsy_TiposAgrupamientoDataTable )dataTable );
		}
