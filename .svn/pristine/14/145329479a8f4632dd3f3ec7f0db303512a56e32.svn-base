namespace mz.erp.ui.forms.classes
{
	...
	public class tsy_ClaseDocumento : IDisposable, IGridDocument
	{
		...
		public string GetLayout()
		{
			...
			returnValue += @"<Column0 ID=""IdClaseDocumento""><Caption>IdClaseDocumento</Caption><DataMember>IdClaseDocumento</DataMember><Key>IdClaseDocumento</Key><Position>0</Position></Column0>";
		...
		{
			return mz.erp.businessrules.tsy_ClaseDocumento.GetList().tsy_ClaseDocumento;
		}
		
		public void Update( object dataTable )
		{
			mz.erp.businessrules.tsy_ClaseDocumento.Update( ( tsy_ClaseDocumentoDataset.tsy_ClaseDocumentoDataTable )dataTable );
		}
