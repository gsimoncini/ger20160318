...
namespace mz.erp.commontypes.data {
    ...
    public class tsh_MovimientosStockDetExDataset : DataSet {
        ...
        protected tsh_MovimientosStockDetExDataset(SerializationInfo info, StreamingContext context) {
        ...
        public class tsh_MovimientosStockDetDataTable : DataTable, System.Collections.IEnumerable {
            ...
            private void InitClass() {
                ...
                this.Constraints.Add(new UniqueConstraint("tsh_MovimientosStockDetExKey1", new DataColumn[] {
