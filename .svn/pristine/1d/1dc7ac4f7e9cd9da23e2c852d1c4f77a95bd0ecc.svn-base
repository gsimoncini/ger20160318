...
namespace mz.erp.commontypes.data {
    ...
    public class FuenteDeCambioDataset : DataSet {
        
        private FuenteDeCambioDataTable tableFuenteDeCambio;
        
        public FuenteDeCambioDataset() {
            this.InitClass();
        ...
        protected FuenteDeCambioDataset(SerializationInfo info, StreamingContext context) {
        ...
        public override DataSet Clone() {
            FuenteDeCambioDataset cln = ((FuenteDeCambioDataset)(base.Clone()));
            cln.InitVars();
            return cln;
        }
        ...
        private void InitClass() {
            this.DataSetName = "FuenteDeCambioDataset";
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/FuenteDeCambio.xsd";
        ...
        public class FuenteDeCambioDataTable : DataTable, System.Collections.IEnumerable {
            ...
            private void InitClass() {
                ...
                this.Constraints.Add(new UniqueConstraint("FuenteDeCambioKey1", new DataColumn[] {
