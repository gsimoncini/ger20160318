namespace mz.erp.ui
{
	...
	public class tlg_ComprobantesRemitos : IDisposable, IGridDocument
	{
		...
		public string GetLayout()
		{
			...
			returnValue += @"<Column3 ID=""Tipo""><Caption>Tipo</Caption><DataMember>Tipo</DataMember><Key>Tipo</Key><Position>3</Position></Column3>";
			returnValue += @"<Column4 ID=""Numero""><Caption>Numero</Caption><DataMember>Numero</DataMember><Key>Numero</Key><Position>4</Position></Column4>";
			returnValue += @"<Column5 ID=""IdRenglon""><Caption>IdRenglon</Caption><DataMember>IdRenglon</DataMember><Key>IdRenglon</Key><Position>5</Position></Column5>";
		...
		{
			return mz.erp.businessrules.tlg_ComprobantesRemitos.GetList().tlg_ComprobantesRemitos;
		}
		
		public void Update( object dataTable )
		{
			mz.erp.businessrules.tlg_ComprobantesRemitos.Update( ( tlg_ComprobantesRemitosDataset.tlg_ComprobantesRemitosDataTable )dataTable );
		}
