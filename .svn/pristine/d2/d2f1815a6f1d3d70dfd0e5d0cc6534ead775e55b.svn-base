...
{
	/// <summary>
	/// Descripción breve de FrmComprobanteDeCompraSelectN.
	/// </summary>
	public class FrmComprobanteDeCompraSelectN : System.Windows.Forms.Form, ITaskForm
	{
		...
		public FrmComprobanteDeCompraSelectN()
		{
			//
		...
		public FrmComprobanteDeCompraSelectN(ComprobantesDeCompraSelectNController controller)
		{
			InitializeComponent();
		...
		private ComprobantesDeCompraSelectNController  _uiController;
		...
		public FrmComprobanteDeCompraSelectN(ArrayList IdComprobantes)
		{
			//
			// Necesario para admitir el Diseñador de Windows Forms
			//
		...
		{			
			...
			gridEX1.LayoutData = string.Empty;
