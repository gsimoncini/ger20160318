...
namespace mz.erp.commontypes.data {
    ...
    public class ProductosSucursalesDataset : DataSet {
        
        private ProductosSucursalesDataTable tableProductosSucursales;
        
        public ProductosSucursalesDataset() {
            this.InitClass();
        ...
        protected ProductosSucursalesDataset(SerializationInfo info, StreamingContext context) {
        ...
        public override DataSet Clone() {
            ProductosSucursalesDataset cln = ((ProductosSucursalesDataset)(base.Clone()));
            cln.InitVars();
            return cln;
        }
        ...
        public class ProductosSucursalesDataTable : DataTable, System.Collections.IEnumerable {
            ...
            private void InitClass() {
                ...
                this.Constraints.Add(new UniqueConstraint("ProductosSucursalesKey1", new DataColumn[] {
