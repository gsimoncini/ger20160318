...
#Region "  Symmetric"
    ...
    Public Class Symmetric
        ...
        Private Const _publicStaticKey As String = "CuloDeMono"
        ...
        ''' </summary>
        Public Sub New()
            Dim useDefaultInitializationVector As Boolean
            useDefaultInitializationVector = True
            ...
            Me.Key = RandomKey()
            Me.Key.Text = Me._publicStaticKey
        ...
        Public Function Encrypt(ByVal s As Stream) As Data
            ...
            Return New Data(ms.ToArray)
        End Function
        Public Function EncryptStringBase64(ByVal s As String) As String
            Dim data As New Encryption.Data(s)
            Return Me.Encrypt(data).ToBase64()
        End Function
        Public Function DecryptStringBase64(ByVal encryptedString As String) As String
            Dim data As New Encryption.Data(Convert.FromBase64String(encryptedString))
            Return Me.Decrypt(data).Text()
        End Function
        ''' <summary>
        ...
        Private Sub LoadKeyXml(ByVal keyXml As String, ByVal isPrivate As Boolean)
            ...
            Catch ex As System.Exception
                ...
                Else
                    s = "public"
                End If
                Throw New Exception(String.Format("The provided {0} encryption key XML does not appear to be valid.", s), ex)
            End Try
        End Sub
            ...
            Catch ex As System.Security.Cryptography.CryptographicException
                If ex.Message.ToLower.IndexOf("csp for this implementation could not be acquired") > -1 Then
                    Throw New Exception("Unable to obtain Cryptographic Service Provider. " & _
                        ...
                        "folder, or the current security context does not have access to this folder.", ex)
                Else
                    Throw
                End If
            Finally
...
#End Region
    Public Class DemoSymetric
        Public Sub DemoSymmetric()
        End Sub
        Public Sub DoDemo()
            ...
            Dim sym As New Encryption.Symmetric
            sym.Key.Text = Key
            ...
            Dim sym2 As New Encryption.Symmetric
