...
namespace mz.erp.dataaccess 
{
	...
	public class tpu_ProveedoresJerarquias : IDisposable
	{
		...
		{
			tpu_ProveedoresJerarquiasDataset data = new tpu_ProveedoresJerarquiasDataset();

			return ( tpu_ProveedoresJerarquiasDataset )GetList( data );
		}

		public static DataSet GetList( DataSet data )
		{
			SqlDataAdapter adapter = new SqlDataAdapter();
			adapter.TableMappings.Add( "Table", "tpu_ProveedoresJerarquias" );
			
			SqlCommand cmd = new SqlCommand( "Pr_tpu_ProveedoresJerarquias_GetList", dbhelper.Connection.GetConnection() );
		...
		public static tpu_ProveedoresJerarquiasDataset GetList( string IdProveedor, string IdNomenclatura1a, string IdNomenclatura1b, string IdNomenclatura1c, string IdNomenclatura1d, string IdNomenclatura2a, string IdNomenclatura2b, string IdNomenclatura2c, string IdNomenclatura2d, string IdNomenclatura3a, string IdNomenclatura3b, string IdNomenclatura3c, string IdNomenclatura3d, string IdNomenclatura4a, string IdNomenclatura4b, string IdNomenclatura4c, string IdNomenclatura4d, string IdNomenclatura5a, string IdNomenclatura5b, string IdNomenclatura5c, string IdNomenclatura5d, string IdNomenclatura6a, string IdNomenclatura6b, string IdNomenclatura6c, string IdNomenclatura6d, string IdNomenclatura7a, string IdNomenclatura7b, string IdNomenclatura7c, string IdNomenclatura7d, string IdNomenclatura8a, string IdNomenclatura8b, string IdNomenclatura8c, string IdNomenclatura8d, string IdNomenclatura9a, string IdNomenclatura9b, string IdNomenclatura9c, string IdNomenclatura9d, string IdNomenclatura10a, string IdNomenclatura10b, string IdNomenclatura10c, string IdNomenclatura10d, bool Activo, DateTime FechaCreacion, long IdConexionCreacion, byte[] UltimaModificacion, long IdConexionUltimaModificacion, long IdReservado, Guid RowId, long IdEmpresa, long IdSucursal )
		{
			...
			SqlCommand cmd = new SqlCommand( "Pr_tpu_ProveedoresJerarquias_Search", dbhelper.Connection.GetConnection() );
			cmd.CommandType = CommandType.StoredProcedure;
		...
		{
			return ( new tpu_ProveedoresJerarquiasDataset() ).tpu_ProveedoresJerarquias.Newtpu_ProveedoresJerarquiasRow();
		}
		...
		public static tpu_ProveedoresJerarquiasDataset.tpu_ProveedoresJerarquiasRow GetByPk( string IdProveedor )
		{
			...
			SqlCommand cmd = new SqlCommand( "Pr_tpu_ProveedoresJerarquias_GetByPk", dbhelper.Connection.GetConnection()  );
			cmd.CommandType = CommandType.StoredProcedure;
			...
			if ( data.tpu_ProveedoresJerarquias.Rows.Count == 1 )
			{
				return ( tpu_ProveedoresJerarquiasDataset.tpu_ProveedoresJerarquiasRow )data.tpu_ProveedoresJerarquias.Rows[ 0 ];
			}
		...
		public static void Update( tpu_ProveedoresJerarquiasDataset.tpu_ProveedoresJerarquiasRow row )
		{
			...
			{
				( ( tpu_ProveedoresJerarquiasDataset.tpu_ProveedoresJerarquiasDataTable )row.Table ).Addtpu_ProveedoresJerarquiasRow( row );
			}
		...
		{
			Update( dataSet.tpu_ProveedoresJerarquias );
		}
		...
		public static void Update( DataTable dataTable )
		{
			...
			try
			{
				Update( ( tpu_ProveedoresJerarquiasDataset.tpu_ProveedoresJerarquiasDataTable )dataTable, trx );
				trx.Commit();
			}
			catch
			{
		...
		public static void Update( tpu_ProveedoresJerarquiasDataset.tpu_ProveedoresJerarquiasDataTable dataTable, SqlTransaction trx )
		{
			SqlDataAdapter adapter = new SqlDataAdapter();
			
			adapter.TableMappings.AddRange(
				new System.Data.Common.DataTableMapping[] {
															  new System.Data.Common.DataTableMapping( "Table", "tpu_ProveedoresJerarquias", 
			...
			SqlCommand sqlCommandUpdate = new SqlCommand( "Pr_tpu_ProveedoresJerarquias_Update", trx.Connection );
			...
			SqlCommand sqlCommandDelete = new SqlCommand( "Pr_tpu_ProveedoresJerarquias_Delete", trx.Connection );
			...
			SqlCommand sqlCommandInsert = new SqlCommand("Pr_tpu_ProveedoresJerarquias_Insert", trx.Connection );
