namespace mz.erp.ui.forms.classes
{
	...
	public class tsy_TiposMovimientos : IDisposable, IGridDocument
	{
		...
		public string GetLayout()
		{
			...
			if ( fl.Contains( "AfectaStock" ) || _fieldList == null ) sb.Append( LayoutBuilder.GetRow( i++, "AfectaStock", "AfectaStock" ) );
		...
		{
			return mz.erp.businessrules.tsy_TiposMovimientos.GetList().tsy_TiposMovimientos;
		}
		
		public void Update( object dataTable )
		{
			mz.erp.businessrules.tsy_TiposMovimientos.Update( ( tsy_TiposMovimientosDataset.tsy_TiposMovimientosDataTable )dataTable );
		}
		...
		[ SearchMember( "tsy_TiposMovimientos" ) ]
		public static DataSet GetList( [ SearchParameterInfo( "IdTipoMovimiento" ) ] string IdTipoMovimiento, 
			[ SearchParameterInfo( "AfectaStock" ) ] bool AfectaStock, 
		...
		{
			tsy_TiposMovimientosDataset data = mz.erp.businessrules.tsy_TiposMovimientos.GetList( IdTipoMovimiento, AfectaStock, Descripcion, Sistema, FechaCreacion, IdConexionCreacion, UltimaModificacion, IdConexionUltimaModificacion, IdReservado, RowId, IdEmpresa );
			return ( DataSet )data;
		}
