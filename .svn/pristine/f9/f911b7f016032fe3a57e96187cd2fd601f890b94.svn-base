namespace mz.erp.dataaccess 
{
	...
	public class tlg_Secciones : IDisposable
	{
        ...
        public static tlg_SeccionesDataset.tlg_SeccionesDataTable GetByIdDepositoDescripcion(string IdDeposito, string Descripcion)
        {
            ...
            SqlCommand cmd = new SqlCommand("Pr_tlg_Secciones_GetByIdDepositoDescripcion", dbhelper.Connection.GetConnection());
            cmd.CommandType = CommandType.StoredProcedure;

            cmd.Parameters.Add(new SqlParameter("@IdDeposito", SqlDbType.VarChar));
            if (IdDeposito == null || IdDeposito.Equals(string.Empty))
...
/*		public static tlg_SeccionesDataset GetList( string IdSeccion, string IdDeposito, string Descripcion, string Ubicacion, string Comentario, long Activo, DateTime FechaCreacion, long IdConexionCreacion, byte[] UltimaModificacion, long IdConexionUltimaModificacion, long IdReservado, Guid RowId, long IdSucursal, long IdEmpresa )
		...
		public static void Update( DataTable dataTable )
		{
			...
			SqlTransaction trx = cnx.BeginTransaction( IsolationLevel.ReadCommitted);//Cristian Tarea 0000082 );
		...
		public static void Update( tlg_SeccionesDataset.tlg_SeccionesDataTable dataTable, SqlTransaction trx )
		{
			...
			sqlCommandInsert.Parameters.Add( new SqlParameter( "@IdSeccion", SqlDbType.VarChar, 20, ParameterDirection.InputOutput, false, ( ( System.Byte )( 0 ) ), ( ( System.Byte )( 0 ) ), "IdSeccion", DataRowVersion.Current, null ) );
