namespace mz.erp.ui.forms.classes
{
	...
	public class tpu_OrdenesRemitosCompras : IDisposable, IGridDocument
	{
		...
		public string GetLayout()
		{
			...
			returnValue += @"<Column1 ID=""RenglonOrden""><Caption>RenglonOrden</Caption><DataMember>RenglonOrden</DataMember><Key>RenglonOrden</Key><Position>1</Position></Column1>";
			returnValue += @"<Column2 ID=""IdRemitosCompra""><Caption>IdRemitosCompra</Caption><DataMember>IdRemitosCompra</DataMember><Key>IdRemitosCompra</Key><Position>2</Position></Column2>";
		...
		{
			return mz.erp.businessrules.tpu_OrdenesRemitosCompras.GetList().tpu_OrdenesRemitosCompras;
		}
		
		public void Update( object dataTable )
		{
			mz.erp.businessrules.tpu_OrdenesRemitosCompras.Update( ( tpu_OrdenesRemitosComprasDataset.tpu_OrdenesRemitosComprasDataTable )dataTable );
		}
