...
namespace mz.erp.commontypes.data {
    ...
    public class tfi_CajasDataset : DataSet {
        
        private tfi_CajasDataTable tabletfi_Cajas;
        
        public tfi_CajasDataset() {
            this.InitClass();
        ...
        protected tfi_CajasDataset(SerializationInfo info, StreamingContext context) {
        ...
        public override DataSet Clone() {
            tfi_CajasDataset cln = ((tfi_CajasDataset)(base.Clone()));
            cln.InitVars();
            return cln;
        }
        ...
        private void InitClass() {
            this.DataSetName = "tfi_CajasDataset";
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/tfi_Cajas.xsd";
        ...
        public class tfi_CajasDataTable : DataTable, System.Collections.IEnumerable {
            ...
            private void InitClass() {
                ...
                this.Constraints.Add(new UniqueConstraint("tfi_CajasDatasetKey1", new DataColumn[] {
