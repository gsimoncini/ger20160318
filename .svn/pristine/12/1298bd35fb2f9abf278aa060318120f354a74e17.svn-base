...
namespace mz.erp.ui.forms
{
	...
	public class FrmVerImputaciones : System.Windows.Forms.Form
	{
		...
		{
			gridAsociaciones.LayoutData = new mz.erp.ui.forms.classes.tsa_CuentaCorriente().GetLayoutDetalleCuentaCorriente(new string [] {"IdComprobante", "Comprobante","Cuota", "FechaVencimiento","Numero", "Saldo","Signo","Pago"});
		...
		{
			gridAsociaciones.DataSource = _itemCuentaCorriente.GetImputaciones();
