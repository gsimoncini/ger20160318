namespace mz.erp.dataaccess 
{
	...
	public class tsh_Agrupamientos : IDisposable
	{
		...
		{
			tsh_AgrupamientosDataset data = new tsh_AgrupamientosDataset();

			return ( tsh_AgrupamientosDataset )GetList( data );
		}

		public static DataSet GetList( DataSet data )
		{
			SqlDataAdapter adapter = new SqlDataAdapter();
			adapter.TableMappings.Add( "Table", "tsh_Agrupamientos" );
			
			SqlCommand cmd = new SqlCommand( "Pr_tsh_Agrupamientos_GetList", dbhelper.Connection.GetConnection() );
		...
		public static tsh_AgrupamientosDataset GetList( string IdProducto, long IdAgrupamiento, DateTime FechaCreacion, long IdConexionCreacion, byte[] UltimaModificacion, long IdConexionUltimaModificacion, long IdReservado, Guid RowId, long IdEmpresa )
		{
			...
			SqlCommand cmd = new SqlCommand( "Pr_tsh_Agrupamientos_Search", dbhelper.Connection.GetConnection() );
			cmd.CommandType = CommandType.StoredProcedure;
		...
		{
			return ( new tsh_AgrupamientosDataset() ).tsh_Agrupamientos.Newtsh_AgrupamientosRow();
		}
		...
		public static tsh_AgrupamientosDataset.tsh_AgrupamientosRow GetByPk( string IdProducto, long IdAgrupamiento )
		{
			...
			SqlCommand cmd = new SqlCommand( "Pr_tsh_Agrupamientos_GetByPk", dbhelper.Connection.GetConnection()  );
			cmd.CommandType = CommandType.StoredProcedure;
			...
			if ( data.tsh_Agrupamientos.Rows.Count == 1 )
			{
				return ( tsh_AgrupamientosDataset.tsh_AgrupamientosRow )data.tsh_Agrupamientos.Rows[ 0 ];
			}
		...
		public static void Update( tsh_AgrupamientosDataset.tsh_AgrupamientosRow row )
		{
			...
			{
				( ( tsh_AgrupamientosDataset.tsh_AgrupamientosDataTable )row.Table ).Addtsh_AgrupamientosRow( row );
			}
		...
		{
			Update( dataSet.tsh_Agrupamientos );
		}
		...
		public static void Update( DataTable dataTable )
		{
			...
			try
			{
				Update( ( tsh_AgrupamientosDataset.tsh_AgrupamientosDataTable )dataTable, trx );
				trx.Commit();
			}
			catch
			{
		...
		public static void Update( tsh_AgrupamientosDataset.tsh_AgrupamientosDataTable dataTable, SqlTransaction trx )
		{
			SqlDataAdapter adapter = new SqlDataAdapter();
			
			adapter.TableMappings.AddRange(
				new System.Data.Common.DataTableMapping[] {
					new System.Data.Common.DataTableMapping( "Table", "tsh_Agrupamientos", 
			...
			SqlCommand sqlCommandUpdate = new SqlCommand( "Pr_tsh_Agrupamientos_Update", trx.Connection );
			...
			SqlCommand sqlCommandDelete = new SqlCommand( "Pr_tsh_Agrupamientos_Delete", trx.Connection );
			...
			SqlCommand sqlCommandInsert = new SqlCommand("Pr_tsh_Agrupamientos_Insert", trx.Connection );
