namespace mz.erp.businessrules 
{
	...
	public class tpu_AplicacionPagos : IDisposable
	{
		...
		/// <summary>
		/// Obtiene la lista completa de la tabla tpu_AplicacionPagos
		/// </summary>
		public static tpu_AplicacionPagosDataset GetList()
		{
			return mz.erp.dataaccess.tpu_AplicacionPagos.GetList();
		}
		
		/// <summary>
		/// Obtiene tabla tpu_AplicacionPagos filtrada por las condiciones de bsqueda
		/// </summary>
		...
		{
			return mz.erp.dataaccess.tpu_AplicacionPagos.GetList( IdComprobanteOrigen, CuotaOrigen, Importe, IdTipoDeComprobanteDestino, IdComprobanteDestino, CuotaDestino );
		}

		/// <summary>
		/// Crea un tpu_AplicacionPagosRow que luego puede ser persistido en la base de datos.
		/// </summary>
		[ atMethodNewRow ]
		public static tpu_AplicacionPagosDataset.tpu_AplicacionPagosRow NewRow()
		{
			return SetRowDefaultValues(mz.erp.dataaccess.tpu_AplicacionPagos.NewRow());
		}

		/// <summary>
		/// Obtiene un registro de la tabla tpu_AplicacionPagos que luego puede ser persistido en la base de datos.
		/// </summary>
		...
		{
			tpu_AplicacionPagosDataset.tpu_AplicacionPagosRow row = mz.erp.dataaccess.tpu_AplicacionPagos.GetByPk( IdComprobanteOrigen, CuotaOrigen, IdComprobanteDestino  );
		...
		/// <summary>
		/// Obtiene un registro de la tabla tpu_AplicacionPagos que luego puede ser persistido en la base de datos. Metodo Sobrecargado
		/// </summary>
		[ atMethodGetByPkRow ]
		public static tpu_AplicacionPagosDataset.tpu_AplicacionPagosRow GetByPk( object IdComprobanteOrigen, object CuotaOrigen,object  IdComprobanteDestino )
		{
			return GetByPk( ( string )IdComprobanteOrigen, ( short )CuotaOrigen, ( string )IdComprobanteDestino );
		}

		/// <summary>
		/// Establece los valores por defecto de tpu_AplicacionPagosRow.
		/// </summary>
		public static tpu_AplicacionPagosDataset.tpu_AplicacionPagosRow SetRowDefaultValues( tpu_AplicacionPagosDataset.tpu_AplicacionPagosRow row )
		{
		...
		/// <summary>
		/// Envia los cambios del tpu_AplicacionPagosRow a la base de datos realizando una validacin previa.
		/// </summary>
		[ atMethodSaveRowWithValidation ]
		public static void UpdateWithValidation( tpu_AplicacionPagosDataset.tpu_AplicacionPagosRow row )
		{
		...
		/// <summary>
		/// Envia los cambios del tpu_AplicacionPagosRow a la base de datos realizando una validacin previa. Mtodo Sobrecargado
		/// </summary>
		public static void UpdateWithValidation( System.Data.DataRow row )
		{
			UpdateWithValidation( ( tpu_AplicacionPagosDataset.tpu_AplicacionPagosRow )row );
		}
		
		/// <summary>
		/// Envia los cambios del tpu_AplicacionPagosRow a la base de datos.
		/// </summary>
		public static void Update( tpu_AplicacionPagosDataset.tpu_AplicacionPagosRow row )
		{
			ApplicationAssert.Check( row != null, "El argumento row no debe ser nulo.", ApplicationAssert.LineNumber );
			
			mz.erp.dataaccess.tpu_AplicacionPagos.Update( row );
		}
		...
		/// <summary>
		/// Envia los cambios del tpu_AplicacionPagosDataset.tpu_AplicacionPagosDataTable a la base de datos.
		/// </summary>
		public static void Update( tpu_AplicacionPagosDataset.tpu_AplicacionPagosDataTable dataTable )
		{
			ApplicationAssert.Check( dataTable != null, "El argumento dataTable no debe ser nulo.", ApplicationAssert.LineNumber );
			ApplicationAssert.Check( dataTable.Rows.Count > 0, "El argumento dataTable debe poseer alguna fila.", ApplicationAssert.LineNumber );
			
			mz.erp.dataaccess.tpu_AplicacionPagos.Update( dataTable );
		}
		
		/// <summary>
		/// Valida un tpu_AplicacionPagosRow.
		/// </summary>
		public static bool RowIsValid( tpu_AplicacionPagosDataset.tpu_AplicacionPagosRow row )
		{
			ApplicationAssert.Check( row != null, "El argumento row no debe ser nulo.", ApplicationAssert.LineNumber );
			bool isValid=true;
			string mensaje;
