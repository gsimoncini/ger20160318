...
namespace mz.erp.ui.forms
{
	...
	/// </summary>
	public class FrmJerarquiaAgrupGeneral : System.Windows.Forms.Form
	{
		...
		/*
		public FrmJerarquiaAgrupGeneral()
		{
			//
		...
		*/
		public FrmJerarquiaAgrupGeneral(string Source)
		{
			//
			// Necesario para admitir el Diseñador de Windows Forms
			//
		...
		{			
			switch(_source.ToUpper())
			{
				...
				case "CUENTAS":
				{
					if (_expandir) {tsa_JerarquiaAgrupCuentas.HijosYNietos(e.TreeNode);}
				}break;
				case "PROVEEDORES":
				{
					if (_expandir) {tpu_JerarquiaAgrupProveedores.HijosYNietos(e.TreeNode);}
				}break;
			}
		}
		...
		{	
			...
			switch(_source.ToUpper())
			{
				...
				case "CUENTAS":
				{
					tsa_JerarquiaAgrupCuentas.HijosYNietos(Nodo);	
				}break;
				case "PROVEEDORES":
				{
					tpu_JerarquiaAgrupProveedores.HijosYNietos(Nodo);	
				}break;
			}
		...
		{					
			...
			FrmAbmJerarquiaAgrupGeneral form = new FrmAbmJerarquiaAgrupGeneral();
			form.ShowForm(_source,  null, Key, 'A', Caption + '-' + Descripcion);						
		...
		{				
			...
			if (Key != ultraTree1.Nodes[0].Key)
			{
				...
				string Caption = "Agrupamientos";		
				FrmAbmJerarquiaAgrupGeneral form = new FrmAbmJerarquiaAgrupGeneral();
				form.ShowForm(_source, Key, KeyP, 'A', Caption + '-' + Descripcion);
				form.OnRowChanged+= new FrmAMB.RowChanged(this.RefreshEvent);
			}
		}
