...
namespace mz.erp.commontypes.data {
    ...
    public class tsy_TiposMovimientosDataset : DataSet {
        ...
        protected tsy_TiposMovimientosDataset(SerializationInfo info, StreamingContext context) {
        ...
        public class tsy_TiposMovimientosDataTable : DataTable, System.Collections.IEnumerable {
            ...
            private void InitClass() {
                ...
                this.Constraints.Add(new UniqueConstraint("tsy_TiposMovimientosDatasetKey1", new DataColumn[] {
