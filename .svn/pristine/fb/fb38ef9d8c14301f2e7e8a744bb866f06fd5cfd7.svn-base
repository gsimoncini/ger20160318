namespace mz.erp.dataaccess 
{
	...
	public class tui_ConfiguracionGrillaEstiloAplicadoPerfiles : IDisposable
	{
		...
		{
			tui_ConfiguracionGrillaEstiloAplicadoPerfilesDataset data = new tui_ConfiguracionGrillaEstiloAplicadoPerfilesDataset();

			return ( tui_ConfiguracionGrillaEstiloAplicadoPerfilesDataset )GetList( data );
		}

		public static DataSet GetList( DataSet data )
		{
			SqlDataAdapter adapter = new SqlDataAdapter();
			adapter.TableMappings.Add( "Table", "tui_ConfiguracionGrillaEstiloAplicadoPerfiles" );
			
			SqlCommand cmd = new SqlCommand( "Pr_tui_ConfiguracionGrillaEstiloAplicadoPerfiles_GetList", dbhelper.Connection.GetConnection() );
		...
		public static tui_ConfiguracionGrillaEstiloAplicadoPerfilesDataset GetList( long IdPerfil, long IdProceso, long IdTarea, string Grilla, string Formulario, long IdConfiguracion, long IdEmpresa, long IdSucursal )
		{
			...
			SqlCommand cmd = new SqlCommand( "Pr_tui_ConfiguracionGrillaEstiloAplicadoPerfiles_Search", dbhelper.Connection.GetConnection() );
			cmd.CommandType = CommandType.StoredProcedure;
		...
		{
			return ( new tui_ConfiguracionGrillaEstiloAplicadoPerfilesDataset() ).tui_ConfiguracionGrillaEstiloAplicadoPerfiles.Newtui_ConfiguracionGrillaEstiloAplicadoPerfilesRow();
		}
		...
		public static tui_ConfiguracionGrillaEstiloAplicadoPerfilesDataset.tui_ConfiguracionGrillaEstiloAplicadoPerfilesRow GetByPk( long IdPerfil, long IdProceso, long IdTarea, string Grilla, long IdConfiguracion )
		{
			...
			SqlCommand cmd = new SqlCommand( "Pr_tui_ConfiguracionGrillaEstiloAplicadoPerfiles_GetByPk", dbhelper.Connection.GetConnection()  );
			cmd.CommandType = CommandType.StoredProcedure;
			...
			if ( data.tui_ConfiguracionGrillaEstiloAplicadoPerfiles.Rows.Count == 1 )
			{
		...
		public static void Update( tui_ConfiguracionGrillaEstiloAplicadoPerfilesDataset.tui_ConfiguracionGrillaEstiloAplicadoPerfilesRow row )
		{
			...
			{
				( ( tui_ConfiguracionGrillaEstiloAplicadoPerfilesDataset.tui_ConfiguracionGrillaEstiloAplicadoPerfilesDataTable )row.Table ).Addtui_ConfiguracionGrillaEstiloAplicadoPerfilesRow( row );
			}
		...
		{
			Update( dataSet.tui_ConfiguracionGrillaEstiloAplicadoPerfiles );
		}
		...
		public static void Update( DataTable dataTable )
		{
			...
			try
			{
				Update( ( tui_ConfiguracionGrillaEstiloAplicadoPerfilesDataset.tui_ConfiguracionGrillaEstiloAplicadoPerfilesDataTable )dataTable, trx );
				trx.Commit();
			}
			catch
			{
		...
		public static void Update( DataTable dataTable, SqlTransaction trx, SentenciasReplicacion replicacion )
		{
			...
			adapter.TableMappings.AddRange(
				new System.Data.Common.DataTableMapping[] {
															  new System.Data.Common.DataTableMapping( "Table", "tui_ConfiguracionGrillaEstiloAplicadoPerfiles", 
			...
			SqlCommand sqlCommandUpdate = new SqlCommand( "Pr_tui_ConfiguracionGrillaEstiloAplicadoPerfiles_Update", trx.Connection );
			...
			SqlCommand sqlCommandDelete = new SqlCommand( "Pr_tui_ConfiguracionGrillaEstiloAplicadoPerfiles_Delete", trx.Connection );
			...
			SqlCommand sqlCommandInsert = new SqlCommand("Pr_tui_ConfiguracionGrillaEstiloAplicadoPerfiles_Insert", trx.Connection );
