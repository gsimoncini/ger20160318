namespace mz.erp.ui.forms.classes
{
	...
	public class tsa_CuentasCondicionesDeVenta : IDisposable, IGridDocument
	{
		public tsa_CuentasCondicionesDeVenta()
		{
		}

		public tsa_CuentasCondicionesDeVenta( string[] fieldList )
		{
		...
		public DataTable GetList()
		{
			...
			return mz.erp.businessrules.tsa_CuentasCondicionesDeVenta.GetList().tsa_CuentasCondicionesDeVenta;
		}
		
		public void Update( object dataTable )
		{
			mz.erp.businessrules.tsa_CuentasCondicionesDeVenta.Update( ( tsa_CuentasCondicionesDeVentaDataset.tsa_CuentasCondicionesDeVentaDataTable )dataTable );
		}
