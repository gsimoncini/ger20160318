...
namespace mz.erp.commontypes.data {
    ...
    public class tpu_ComprobantesCompraExDataset : DataSet {
        
        private tpu_ComprobantesCompraDataTable tabletpu_ComprobantesCompra;
        
        public tpu_ComprobantesCompraExDataset() {
            this.InitClass();
        ...
        protected tpu_ComprobantesCompraExDataset(SerializationInfo info, StreamingContext context) {
        ...
        public override DataSet Clone() {
            tpu_ComprobantesCompraExDataset cln = ((tpu_ComprobantesCompraExDataset)(base.Clone()));
            cln.InitVars();
            return cln;
        }
        ...
        private void InitClass() {
            this.DataSetName = "tpu_ComprobantesCompraExDataset";
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/tpu_ComprobantesCompraEx.xsd";
        ...
        public class tpu_ComprobantesCompraDataTable : DataTable, System.Collections.IEnumerable {
            ...
            private void InitClass() {
                ...
                this.Constraints.Add(new UniqueConstraint("tpu_ComprobantesCompraExKey1", new DataColumn[] {
