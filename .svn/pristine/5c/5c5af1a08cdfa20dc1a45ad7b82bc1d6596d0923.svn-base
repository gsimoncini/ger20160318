...
namespace mz.erp.ui.controllers
{
	...
	/// </summary>
	public class ConsultasCajaController: ITaskController
	{
		...
		{
			set{_brClass.SelectedRow = value;}
			get{return _brClass.SelectedRow;}
		}
		...
		public ConsultasCajaController()
		{
			_brClass = new mz.erp.businessrules.ConsultasDeCaja();
			Init();
		}

		public ConsultasCajaController( mz.erp.businessrules.ConsultasDeCaja brClass )
		{
			_brClass = brClass;
			Init();
		}
		...
		public bool ObligaSeleccionItem()
		{
			...
			{
				case "ConsultarValoresCajas": //pantalla de ajuste
					return true;
					break;
		...
		public bool PreguntarAlCancelar()
		{
			string _nombreProceso = this._brClass.GetProcessManagerParent().Process.ProcessName;
			string _nombreTarea = this._brClass.GetTaskName();
			_preguntarAlCancelar = Variables.GetValueBool(_nombreProceso,_nombreTarea,"PreguntarAlCancelar");
		...
		public void TildarTodosTDCompTesoreria()
		{
			foreach( mz.erp.businessrules.ItemsFiltros items in this.FiltroTDCompTesoreria )
				items.Sel = true;
		}
		
		public void TildarNingunoTDCompTesoreria()
		{
			foreach( mz.erp.businessrules.ItemsFiltros items in this.FiltroTDCompTesoreria )
				items.Sel = false;
		}
		...
		public void TildarNingunoUsuarios()
		{
			foreach( mz.erp.businessrules.ItemsFiltros items in this.FiltroCajas )
				items.Sel = false;
		}
		...
		{
			get { return _brClass.CheckFechaMovimientos ; }
			set { _brClass.CheckFechaMovimientos = value ; }
		}


		public bool CheckUltimaCaja
		{
			get { return _brClass.CheckUltimaCaja ; }
			set { _brClass.CheckUltimaCaja = value ; }
		}
		...
		{
			get{return _brClass.FiltroFechaMovimiento;}
		}
		...
		public string GetHTMLValoresDatosAuxiliares(string IdValor)
		{
			return mz.erp.businessrules.tfi_ValoresDatosAuxiliares.GetHTML(IdValor);
		}
