namespace mz.erp.dataaccess 
{
	...
	public class tsa_AplicacionPagos : IDisposable
	{
		...
		public static DataSet GetList( DataSet data )
		{
			...
			SqlCommand cmd = new SqlCommand( "Pr_tsa_AplicacionPagos_GetList", dbhelper.Connection.GetConnection() );
		...
		public static tsa_AplicacionPagosDataset GetList( string IdComprobanteOrigen, short CuotaOrigen, decimal Importe, string IdTipoDeComprobanteDestino, string IdComprobanteDestino, short CuotaDestino )
		{
			...
			if(CuotaOrigen == short.MinValue ) cmd.Parameters[ "@CuotaOrigen" ].Value = System.DBNull.Value;
			else
				cmd.Parameters[ "@CuotaOrigen" ].Value = CuotaOrigen;
			cmd.Parameters.Add( new SqlParameter( "@Importe", SqlDbType.Decimal ) );
			if (Importe == decimal.MinValue) cmd.Parameters[ "@Importe" ].Value = System.DBNull.Value;
			else
			...
			if(CuotaDestino == short.MinValue) cmd.Parameters[ "@CuotaDestino" ].Value = System.DBNull.Value;
			else
		...
		{
			return ( new tsa_AplicacionPagosDataset() ).tsa_AplicacionPagos.Newtsa_AplicacionPagosRow();
		}
		...
		public static void Update( DataTable dataTable )
		{
			...
			try
			{
				Update( ( tsa_AplicacionPagosDataset.tsa_AplicacionPagosDataTable )dataTable, trx );
				trx.Commit();
			}
			catch
			{
		...
		public static void Update( System.Data.DataTable dataTable, SqlTransaction trx )
		{
			...
			adapter.TableMappings.AddRange(
				new System.Data.Common.DataTableMapping[] {
															  new System.Data.Common.DataTableMapping( "Table", "tsa_AplicacionPagos", 
			...
			SqlCommand sqlCommandUpdate = new SqlCommand( "Pr_tsa_AplicacionPagos_Update", trx.Connection );
			...
			SqlCommand sqlCommandDelete = new SqlCommand( "Pr_tsa_AplicacionPagos_Delete", trx.Connection );
			...
			SqlCommand sqlCommandInsert = new SqlCommand("Pr_tsa_AplicacionPagos_Insert", trx.Connection );
