...
namespace mz.erp.ui.forms
{
	...
	/// </summary>
	public class FrmIngresarPrecioProducto : System.Windows.Forms.Form, ITaskForm
	{
		...
		*/
		...
		private void ConfigureInterface()
		{
			...
			unePrecioDeCostoMonedaProducto.ReadOnly = true;
			//Sabrina: tarea 56
			...
			/**************************/
			unePrecioDeCostoMonedaProducto.ReadOnly = true;//_uiController.ReadOnlyPrecioDeCostoMonedaProducto;
			/**************************/
            ...
            */
			...
			unePrecioDeCostoReposicion.ReadOnly = !_uiController.PermiteModificarPrecioDeCostoReposicion;
		...
		private void HabilitarCostosIndirectos()
		{
			...
			/*
			if ( _uiController.CoeficienteCreadoyActivo(6) )
			{
				if ( _uiController.CostoIndirectoActivo6 )
				{
			...
			{
				chkCoef6.Enabled = false;
				uneCoeficiente6.Enabled = false;
				uneCoeficientePorc6.Enabled = false;
			}

			if ( _uiController.CoeficienteCreadoyActivo(7) )
			{
				if ( _uiController.CostoIndirectoActivo7 )
				{
			...
			{
				chkCoef7.Enabled = false;
				uneCoeficiente7.Enabled = false;
				uneCoeficientePorc7.Enabled = false;
			}

			if ( _uiController.CoeficienteCreadoyActivo(8) )
			{
				if ( _uiController.CostoIndirectoActivo8 )
				{
			...
			{
				chkCoef8.Enabled = false;
				uneCoeficiente8.Enabled = false;
				uneCoeficientePorc8.Enabled = false;
			}

			if ( _uiController.CoeficienteCreadoyActivo(9) )
			{
				if ( _uiController.CostoIndirectoActivo9 )
				{
			...
			{
				chkCoef9.Enabled = false;
				uneCoeficiente9.Enabled = false;
				uneCoeficientePorc9.Enabled = false;
			}

			if ( _uiController.CoeficienteCreadoyActivo(10) )
			{
				if ( _uiController.CostoIndirectoActivo10 )
				{
		...
		{				
			...
			unePrecioPPCostoAnteriorMonedaProducto.DataBindings.Add("Value", _uiController, "PrecioCostoAnterior");
			...
			//mzCmbProveedor.DataBindings.Add("DataValue",_uiController,"IdProveedor");
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(FrmIngresarPrecioProducto));
			...
			this.ultraExplorerBarContainerControl2.Size = new System.Drawing.Size(814, 36);
			...
			this.containerProductos.Location = new System.Drawing.Point(28, 119);
			this.containerProductos.Name = "containerProductos";
			this.containerProductos.Size = new System.Drawing.Size(814, 221);
			...
			this.bNingunoCaja.Location = new System.Drawing.Point(400, 11);
			...
			this.bTodosCaja.Location = new System.Drawing.Point(336, 11);
			...
			this.rbSeleccionMultiple.TabIndex = 1;
			...
			this.rbSeleccionSimple.TabIndex = 0;
			...
			this.gridProductos.Location = new System.Drawing.Point(16, 88);
			...
			this.ultraExplorerBarContainerControl3.Location = new System.Drawing.Point(28, 399);
			this.ultraExplorerBarContainerControl3.Name = "ultraExplorerBarContainerControl3";
			this.ultraExplorerBarContainerControl3.Size = new System.Drawing.Size(814, 383);
			...
			this.gridListaDePreciosProveedores.Size = new System.Drawing.Size(816, 160);
			this.gridListaDePreciosProveedores.TabIndex = 146;
			...
			this.groupBox4.Size = new System.Drawing.Size(814, 186);
			...
			this.groupBox3.Size = new System.Drawing.Size(814, 32);
			...
			this.btnEliminarListaDePreciosProv.Location = new System.Drawing.Point(696, 8);
			...
			this.btnEliminarListaDePreciosProv.TabIndex = 56;
			...
			this.containerDatosCompra.Location = new System.Drawing.Point(28, 98);
			this.containerDatosCompra.Name = "containerDatosCompra";
			this.containerDatosCompra.Size = new System.Drawing.Size(815, 259);
			this.containerDatosCompra.TabIndex = 0;
			this.containerDatosCompra.Visible = false;
			// 
			// groupMZ
			// 
			...
			this.groupMZ.Enter += new System.EventHandler(this.groupMZ_Enter);
			// 
			...
			this.ultraLabel11.Size = new System.Drawing.Size(147, 13);
			this.ultraLabel11.TabIndex = 72;
			this.ultraLabel11.Text = "Precio de Costo Anterior";
			...
			// ultraCoeficiente10
			// 
			this.ultraCoeficiente10.BackColor = System.Drawing.Color.Transparent;
			...
			// ultraCoeficiente9
			// 
			this.ultraCoeficiente9.BackColor = System.Drawing.Color.Transparent;
			...
			// ultraCoeficiente8
			// 
			this.ultraCoeficiente8.BackColor = System.Drawing.Color.Transparent;
			...
			// ultraCoeficiente7
			// 
			this.ultraCoeficiente7.BackColor = System.Drawing.Color.Transparent;
			...
			// ultraCoeficiente6
			// 
			this.ultraCoeficiente6.BackColor = System.Drawing.Color.Transparent;
			...
			this.groupDatosProveedor.Size = new System.Drawing.Size(815, 88);
			...
			this.containerDatosVenta.Location = new System.Drawing.Point(28, 416);
			this.containerDatosVenta.Name = "containerDatosVenta";
			this.containerDatosVenta.Size = new System.Drawing.Size(815, 128);
			...
			this.ultraExplorerBarContainerControl1.Location = new System.Drawing.Point(28, 404);
			this.ultraExplorerBarContainerControl1.Name = "ultraExplorerBarContainerControl1";
			this.ultraExplorerBarContainerControl1.Size = new System.Drawing.Size(815, 320);
			...
			this.groupBox2.Size = new System.Drawing.Size(814, 120);
			...
			this.gridListaDePrecios.Size = new System.Drawing.Size(816, 160);
			...
			ultraExplorerBarGroup1.Settings.ContainerHeight = 36;
			...
			ultraExplorerBarGroup3.Settings.ContainerHeight = 383;
			...
			ultraExplorerBarGroup5.Settings.ContainerHeight = 128;
			...
			this.ultraExplorerBar.Size = new System.Drawing.Size(880, 490);
		...
		{
			string idProv = mzCmbProveedor.DataValue.ToString();
