...
{
	/// <summary>
	/// Descripción breve de FrmExportarImpuestos.
	/// </summary>
	public class FrmExportarImpuestos : System.Windows.Forms.Form
	{
		...
		public FrmExportarImpuestos()
		{
			_uiController = new ExportarImpuestosController();
			this.InitializeComponent();
			this.Build_UI();
		}

		public FrmExportarImpuestos(string key)
		{
			_uiController = new ExportarImpuestosController(key);
			this.InitializeComponent();
			this.Build_UI();
		}

		#region Variables Privadas
        ExportarImpuestosController _uiController;
		#endregion
