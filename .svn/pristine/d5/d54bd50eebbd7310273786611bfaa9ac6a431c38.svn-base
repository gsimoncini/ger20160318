namespace mz.erp.ui.forms.classes
{
	...
	public class tpu_Proveedores : IDisposable, IGridDocument
	{
		...
		public string GetLayout()
		{
			...
			if ( fl.Contains( "Numero" ) || _fieldList == null ) sb.Append( LayoutBuilder.GetRow( i++, "Numero", "Numero", true ) );
			...
			if ( fl.Contains( "Telefonos" ) || _fieldList == null ) sb.Append( LayoutBuilder.GetRow( i++, "Telefonos", "Telefonos",200 ) );
			...
			if ( fl.Contains( "BonificacionGeneral" ) || _fieldList == null ) sb.Append( LayoutBuilder.GetRow( i++, "BonificacionGeneral", "Bonificacion General",true ) );
