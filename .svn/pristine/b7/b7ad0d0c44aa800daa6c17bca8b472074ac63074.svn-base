...
namespace mz.erp.commontypes.data {
    ...
    public class tsh_PersonasExDataset : DataSet {
        
        private tsh_PersonasDataTable tabletsh_Personas;
        
        public tsh_PersonasExDataset() {
            this.InitClass();
        ...
        protected tsh_PersonasExDataset(SerializationInfo info, StreamingContext context) {
        ...
        public override DataSet Clone() {
            tsh_PersonasExDataset cln = ((tsh_PersonasExDataset)(base.Clone()));
            cln.InitVars();
            return cln;
        }
        ...
        private void InitClass() {
            this.DataSetName = "tsh_PersonasExDataset";
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/tsh_PersonasEx.xsd";
        ...
        public class tsh_PersonasDataTable : DataTable, System.Collections.IEnumerable {
            ...
            public tsh_PersonasRow Addtsh_PersonasRow(string IdPersona, string Nombre, string Comentarios, string Telefonos, string Email, string InstantMesseger, string Observaciones, System.DateTime FechaCreacion, long IdConexionCreacion, System.Byte[] UltimaModificacion, long IdConexionUltimaModificacion, long IdReservado, System.Guid RowId, long IdTratamiento, long IdEmpresa) {
            ...
            private void InitClass() {
                ...
                this.Constraints.Add(new UniqueConstraint("tsh_PersonasExKey1", new DataColumn[] {
