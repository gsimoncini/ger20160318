...
namespace mz.erp.commontypes.data {
    ...
    public class tsh_StockExDataset : DataSet {
        
        private tsh_StockDataTable tabletsh_Stock;
        
        public tsh_StockExDataset() {
            this.InitClass();
        ...
        protected tsh_StockExDataset(SerializationInfo info, StreamingContext context) {
        ...
        public override DataSet Clone() {
            tsh_StockExDataset cln = ((tsh_StockExDataset)(base.Clone()));
            cln.InitVars();
            return cln;
        }
        ...
        private void InitClass() {
            this.DataSetName = "tsh_StockExDataset";
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/tsh_StockEx.xsd";
        ...
        public class tsh_StockDataTable : DataTable, System.Collections.IEnumerable {
            ...
            private void InitClass() {
                ...
                this.Constraints.Add(new UniqueConstraint("tsh_StockExKey1", new DataColumn[] {
