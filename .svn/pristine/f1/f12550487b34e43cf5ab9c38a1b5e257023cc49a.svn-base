namespace mz.erp.dataaccess 
{
	...
	public class tlg_Depositos : IDisposable
	{
		...
		public static void Update( tlg_DepositosDataset.tlg_DepositosDataTable dataTable, SqlTransaction trx )
		{
			...
			sqlCommandInsert.Parameters.Add( new SqlParameter( "@IdDeposito", SqlDbType.VarChar, 20, ParameterDirection.InputOutput, false, ( ( System.Byte )( 0 ) ), ( ( System.Byte )( 0 ) ), "IdDeposito", DataRowVersion.Current, null ) );
