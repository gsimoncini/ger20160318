...
namespace mz.erp.commontypes.data {
    ...
    public class ListasdePreciosExDataset : DataSet {
        
        private ListasdePreciosDataTable tableListasdePrecios;
        
        public ListasdePreciosExDataset() {
            this.InitClass();
        ...
        protected ListasdePreciosExDataset(SerializationInfo info, StreamingContext context) {
        ...
        public override DataSet Clone() {
            ListasdePreciosExDataset cln = ((ListasdePreciosExDataset)(base.Clone()));
            cln.InitVars();
            return cln;
        }
        ...
        private void InitClass() {
            this.DataSetName = "ListasdePreciosExDataset";
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/ListasdePreciosEx.xsd";
        ...
        public class ListasdePreciosDataTable : DataTable, System.Collections.IEnumerable {
            ...
            private void InitClass() {
                ...
                this.Constraints.Add(new UniqueConstraint("ListasdePreciosExKey1", new DataColumn[] {
