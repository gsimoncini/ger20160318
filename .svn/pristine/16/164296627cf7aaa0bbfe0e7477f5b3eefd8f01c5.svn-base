namespace mz.erp.businessrules 
{
	...
	public class tpu_ComprobanteDetalleDeuda : IDisposable
	{
		...
		public static void Update( tpu_ComprobanteDetalleDeudaDataset.tpu_ComprobanteDetalleDeudaDataTable dataTable, string IdTransaction, SentenciasReplicacion replication)
		{						
			mz.erp.dataaccess.tpu_ComprobanteDetalleDeuda.Update(dataTable, IdTransaction, replication);
		}		
		/*
		public static System.Data.DataRow NewRow(tpu_ComprobantesExDataset data)
		{
		
			System.Data.DataRow row =  mz.erp.dataaccess.tpu_ComprobanteDetalleDeuda.NewRow( data);
		...
		public static System.Data.DataRow NewRow(tpu_ComprobantesExDataset data,string IdComprobante)
		{
		...
		*/
		...
		/// <summary>
		/// Obtiene tabla tpu_ComprobanteDetalleDeuda filtrada por las condiciones de bsqueda
		/// </summary>
//		public static tpu_ComprobanteDetalleDeudaDataset GetList( string IdComprobante, string IdTipoDeComprobante, string Numero )
//		{
//			return mz.erp.dataaccess.tpu_ComprobanteDetalleDeuda.GetList( IdComprobante, IdTipoDeComprobante, Numero );
//		}		
		...
		/// <summary>
		/// Obtiene la lista completa de la tabla tpu_ComprobanteDetalleDeuda
		/// </summary>
		public static tpu_ComprobanteDetalleDeudaDataset GetList()
		{
			return mz.erp.dataaccess.tpu_ComprobanteDetalleDeuda.GetList();
		}
		


		/// <summary>
		/// Crea un tpu_ComprobanteDetalleDeudaRow que luego puede ser persistido en la base de datos.
		/// </summary>
		[ atMethodNewRow ]
		public static tpu_ComprobanteDetalleDeudaDataset.tpu_ComprobanteDetalleDeudaRow NewRow()
		{
			return (tpu_ComprobanteDetalleDeudaDataset.tpu_ComprobanteDetalleDeudaRow )SetRowDefaultValues(mz.erp.dataaccess.tpu_ComprobanteDetalleDeuda.NewRow());
		}
		...
		/// <summary>
		/// Obtiene un registro de la tabla tpu_ComprobanteDetalleDeuda que luego puede ser persistido en la base de datos. Metodo Sobrecargado
		/// </summary>
		[ atMethodGetByPkRow ]
		public static tpu_ComprobanteDetalleDeudaDataset.tpu_ComprobanteDetalleDeudaRow GetByPk( object IdComprobante, object Cuota )
		{
			return GetByPk( ( string )IdComprobante, ( short )Cuota );
		}

		/// <summary>
		/// Establece los valores por defecto de tpu_ComprobanteDetalleDeudaRow.
		/// </summary>
		...
		/// <summary>
		/// Envia los cambios del tpu_ComprobanteDetalleDeudaRow a la base de datos realizando una validacin previa.
		/// </summary>
		...
		/// <summary>
		/// Envia los cambios del tpu_ComprobanteDetalleDeudaRow a la base de datos realizando una validacin previa. Mtodo Sobrecargado
		/// </summary>
		public static void UpdateWithValidation( System.Data.DataRow row )
		{
			UpdateWithValidation( ( tpu_ComprobanteDetalleDeudaDataset.tpu_ComprobanteDetalleDeudaRow )row );
		}
		...
		/// <summary>
		/// Envia los cambios del tpu_ComprobanteDetalleDeudaDataset a la base de datos.
		/// </summary>
		public static void Update( tpu_ComprobanteDetalleDeudaDataset dataSet )
		{
			ApplicationAssert.Check( dataSet != null, "El argumento dataSet no debe ser nulo.", ApplicationAssert.LineNumber );
			ApplicationAssert.Check( dataSet.tpu_ComprobanteDetalleDeuda.Rows.Count > 0, "La tabla dataSet.tpu_ComprobanteDetalleDeudaDataTable debe poseer alguna fila.", ApplicationAssert.LineNumber );
			
			mz.erp.dataaccess.tpu_ComprobanteDetalleDeuda.Update( dataSet );
		}
		
		/// <summary>
		/// Envia los cambios del tpu_ComprobanteDetalleDeudaDataset.tpu_ComprobanteDetalleDeudaDataTable a la base de datos.
		/// </summary>
		public static void Update( tpu_ComprobanteDetalleDeudaDataset.tpu_ComprobanteDetalleDeudaDataTable dataTable )
		{
			ApplicationAssert.Check( dataTable != null, "El argumento dataTable no debe ser nulo.", ApplicationAssert.LineNumber );
			ApplicationAssert.Check( dataTable.Rows.Count > 0, "El argumento dataTable debe poseer alguna fila.", ApplicationAssert.LineNumber );
			
			mz.erp.dataaccess.tpu_ComprobanteDetalleDeuda.Update( dataTable );
		}
