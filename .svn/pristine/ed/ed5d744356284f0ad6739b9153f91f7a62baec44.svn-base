namespace mz.erp.businessrules 
{
	...
	public class tpu_ComprobanteDetalleDePagos : IDisposable
	{
		...
		/// <summary>
		/// Obtiene la lista completa de la tabla tpu_ComprobanteDetalleDePagos
		/// </summary>
		public static tpu_ComprobanteDetalleDePagosDataset GetList()
		{
			return mz.erp.dataaccess.tpu_ComprobanteDetalleDePagos.GetList();
		}
		
		/// <summary>
		/// Obtiene tabla tpu_ComprobanteDetalleDePagos filtrada por las condiciones de bsqueda
		/// </summary>
		...
		{
			return mz.erp.dataaccess.tpu_ComprobanteDetalleDePagos.GetList( IdTipoDeComprobante, Numero, IdComprobante, IdValor, Monto );
		}

		/// <summary>
		/// Crea un tpu_ComprobanteDetalleDePagosRow que luego puede ser persistido en la base de datos.
		/// </summary>
		[ atMethodNewRow ]
		public static tpu_ComprobanteDetalleDePagosDataset.tpu_ComprobanteDetalleDePagosRow NewRow()
		{
			return SetRowDefaultValues(mz.erp.dataaccess.tpu_ComprobanteDetalleDePagos.NewRow());
		}

		/// <summary>
		/// Obtiene un registro de la tabla tpu_ComprobanteDetalleDePagos que luego puede ser persistido en la base de datos.
		/// </summary>
		...
		{
			tpu_ComprobanteDetalleDePagosDataset.tpu_ComprobanteDetalleDePagosRow row = mz.erp.dataaccess.tpu_ComprobanteDetalleDePagos.GetByPk( IdComprobante, IdValor  );
		...
		/// <summary>
		/// Obtiene un registro de la tabla tpu_ComprobanteDetalleDePagos que luego puede ser persistido en la base de datos. Metodo Sobrecargado
		/// </summary>
		[ atMethodGetByPkRow ]
		public static tpu_ComprobanteDetalleDePagosDataset.tpu_ComprobanteDetalleDePagosRow GetByPk( object IdComprobante, object IdValor )
		{
			return GetByPk( ( string )IdComprobante, ( string )IdValor );
		}

		/// <summary>
		/// Establece los valores por defecto de tpu_ComprobanteDetalleDePagosRow.
		/// </summary>
		public static tpu_ComprobanteDetalleDePagosDataset.tpu_ComprobanteDetalleDePagosRow SetRowDefaultValues( tpu_ComprobanteDetalleDePagosDataset.tpu_ComprobanteDetalleDePagosRow row )
		{
		...
		/// <summary>
		/// Envia los cambios del tpu_ComprobanteDetalleDePagosRow a la base de datos realizando una validacin previa.
		/// </summary>
		[ atMethodSaveRowWithValidation ]
		public static void UpdateWithValidation( tpu_ComprobanteDetalleDePagosDataset.tpu_ComprobanteDetalleDePagosRow row )
		{
		...
		/// <summary>
		/// Envia los cambios del tpu_ComprobanteDetalleDePagosRow a la base de datos realizando una validacin previa. Mtodo Sobrecargado
		/// </summary>
		public static void UpdateWithValidation( System.Data.DataRow row )
		{
			UpdateWithValidation( ( tpu_ComprobanteDetalleDePagosDataset.tpu_ComprobanteDetalleDePagosRow )row );
		}
		
		/// <summary>
		/// Envia los cambios del tpu_ComprobanteDetalleDePagosRow a la base de datos.
		/// </summary>
		public static void Update( tpu_ComprobanteDetalleDePagosDataset.tpu_ComprobanteDetalleDePagosRow row )
		{
			ApplicationAssert.Check( row != null, "El argumento row no debe ser nulo.", ApplicationAssert.LineNumber );
			
			mz.erp.dataaccess.tpu_ComprobanteDetalleDePagos.Update( row );
		}
		...
		/// <summary>
		/// Envia los cambios del tpu_ComprobanteDetalleDePagosDataset.tpu_ComprobanteDetalleDePagosDataTable a la base de datos.
		/// </summary>
		public static void Update( tpu_ComprobanteDetalleDePagosDataset.tpu_ComprobanteDetalleDePagosDataTable dataTable )
		{
			ApplicationAssert.Check( dataTable != null, "El argumento dataTable no debe ser nulo.", ApplicationAssert.LineNumber );
			ApplicationAssert.Check( dataTable.Rows.Count > 0, "El argumento dataTable debe poseer alguna fila.", ApplicationAssert.LineNumber );
			
			mz.erp.dataaccess.tpu_ComprobanteDetalleDePagos.Update( dataTable );
		}
		
		/// <summary>
		/// Valida un tpu_ComprobanteDetalleDePagosRow.
		/// </summary>
		public static bool RowIsValid( tpu_ComprobanteDetalleDePagosDataset.tpu_ComprobanteDetalleDePagosRow row )
		{
			ApplicationAssert.Check( row != null, "El argumento row no debe ser nulo.", ApplicationAssert.LineNumber );
			bool isValid=true;
			string mensaje;
