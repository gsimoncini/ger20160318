...
{
	/// <summary>
	/// Descripción breve de DetalleComprobantesDeCompraPendientes.
	/// </summary>
	public class DetalleComprobantesDeCompraPendientes
	{
		public DetalleComprobantesDeCompraPendientes()
		{
			//
		...
		public static System.Data.DataSet GetList( string IdProveedor, DateTime FechaDesde, DateTime FechaHasta, string IdResponsable, string TiposDeComprobantes)
		{
			...
			return mz.erp.businessrules.reportes.ReportsFactory.DetalleComprobantesDeCompras( TiposDeComprobantes,IdProveedor, FechaDesde, FechaHasta,  IdResponsable, Security.IdSucursal, Security.IdEmpresa);
