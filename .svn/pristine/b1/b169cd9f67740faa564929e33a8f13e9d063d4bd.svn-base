...
namespace mz.erp.commontypes.data {
    ...
    public class PerfilesDataset : DataSet {
        ...
        protected PerfilesDataset(SerializationInfo info, StreamingContext context) {
        ...
        public class PerfilesDataTable : DataTable, System.Collections.IEnumerable {
            ...
            private void InitClass() {
                ...
                this.Constraints.Add(new UniqueConstraint("PerfilesDatasetKey1", new DataColumn[] {
