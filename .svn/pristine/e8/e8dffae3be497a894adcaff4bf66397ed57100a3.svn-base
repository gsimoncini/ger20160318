...
namespace mz.erp.commontypes.data {
    ...
    public class sy_BarrasHerramientasHerramientasExDataset : DataSet {
        ...
        protected sy_BarrasHerramientasHerramientasExDataset(SerializationInfo info, StreamingContext context) {
        ...
        public class sy_BarrasHerramientasHerramientasDataTable : DataTable, System.Collections.IEnumerable {
            ...
            private void InitClass() {
                ...
                this.Constraints.Add(new UniqueConstraint("sy_BarrasHerramientasHerramientasExKey1", new DataColumn[] {
