...
namespace mz.erp.commontypes.data {
    ...
    public class PerfilesFuncionalidadesExDataset : DataSet {
        
        private PerfilesFuncionalidadesDataTable tablePerfilesFuncionalidades;
        
        public PerfilesFuncionalidadesExDataset() {
            this.InitClass();
        ...
        protected PerfilesFuncionalidadesExDataset(SerializationInfo info, StreamingContext context) {
        ...
        public override DataSet Clone() {
            PerfilesFuncionalidadesExDataset cln = ((PerfilesFuncionalidadesExDataset)(base.Clone()));
            cln.InitVars();
            return cln;
        }
        ...
        private void InitClass() {
            this.DataSetName = "PerfilesFuncionalidadesExDataset";
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/PerfilesFuncionalidadesExDataset.xsd";
        ...
        public class PerfilesFuncionalidadesDataTable : DataTable, System.Collections.IEnumerable {
            ...
            private void InitClass() {
                ...
                this.Constraints.Add(new UniqueConstraint("PerfilesFuncionalidadesExDatasetKey1", new DataColumn[] {
                                this.columnIdPerfil,
