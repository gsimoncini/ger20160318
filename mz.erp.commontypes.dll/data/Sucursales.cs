...
namespace mz.erp.commontypes.data {
    ...
    public class SucursalesDataset : DataSet {
        
        private SucursalesDataTable tableSucursales;
        
        public SucursalesDataset() {
            this.InitClass();
        ...
        protected SucursalesDataset(SerializationInfo info, StreamingContext context) {
        ...
        public override DataSet Clone() {
            SucursalesDataset cln = ((SucursalesDataset)(base.Clone()));
            cln.InitVars();
            return cln;
        }
        ...
        private void InitClass() {
            this.DataSetName = "SucursalesDataset";
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/Sucursales.xsd";
        ...
        public class SucursalesDataTable : DataTable, System.Collections.IEnumerable {
            ...
            private void InitClass() {
                ...
                this.Constraints.Add(new UniqueConstraint("SucursalesKey1", new DataColumn[] {
