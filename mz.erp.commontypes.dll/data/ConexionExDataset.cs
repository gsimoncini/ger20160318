...
namespace mz.erp.commontypes.data {
    ...
    public class ConexionExDataset : DataSet {
        
        private ConexionDataTable tableConexion;
        
        public ConexionExDataset() {
            this.InitClass();
        ...
        protected ConexionExDataset(SerializationInfo info, StreamingContext context) {
        ...
        public override DataSet Clone() {
            ConexionExDataset cln = ((ConexionExDataset)(base.Clone()));
            cln.InitVars();
            return cln;
        }
        ...
        private void InitClass() {
            this.DataSetName = "ConexionExDataset";
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/ConexionExDataset.xsd";
        ...
        public class ConexionDataTable : DataTable, System.Collections.IEnumerable {
            ...
            private void InitClass() {
                ...
                this.Constraints.Add(new UniqueConstraint("ConexionExDatasetKey1", new DataColumn[] {
