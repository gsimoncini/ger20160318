...
namespace mz.erp.commontypes.data {
    ...
    public class GruposExDataset : DataSet {
        
        private GruposDataTable tableGrupos;
        
        public GruposExDataset() {
            this.InitClass();
        ...
        protected GruposExDataset(SerializationInfo info, StreamingContext context) {
        ...
        public override DataSet Clone() {
            GruposExDataset cln = ((GruposExDataset)(base.Clone()));
            cln.InitVars();
            return cln;
        }
        ...
        private void InitClass() {
            this.DataSetName = "GruposExDataset";
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/GruposExDataset.xsd";
        ...
        public class GruposDataTable : DataTable, System.Collections.IEnumerable {
            ...
            private void InitClass() {
                ...
                this.Constraints.Add(new UniqueConstraint("GruposExDatasetKey1", new DataColumn[] {
