...
namespace mz.erp.commontypes.data {
    ...
    public class tlg_RemitoExDataset : DataSet {
        
        private tlg_RemitoDataTable tabletlg_Remito;
        
        public tlg_RemitoExDataset() {
            this.InitClass();
        ...
        protected tlg_RemitoExDataset(SerializationInfo info, StreamingContext context) {
        ...
        public override DataSet Clone() {
            tlg_RemitoExDataset cln = ((tlg_RemitoExDataset)(base.Clone()));
            cln.InitVars();
            return cln;
        }
        ...
        public class tlg_RemitoDataTable : DataTable, System.Collections.IEnumerable {
            ...
            private void InitClass() {
                ...
                this.Constraints.Add(new UniqueConstraint("tlg_RemitoExKey1", new DataColumn[] {
