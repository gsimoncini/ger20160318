...
namespace mz.erp.commontypes.data {
    ...
    public class tsa_DescuentosPorVolumenDataset : DataSet {
        
        private tsa_DescuentosPorVolumenDataTable tabletsa_DescuentosPorVolumen;
        
        public tsa_DescuentosPorVolumenDataset() {
            this.InitClass();
        ...
        protected tsa_DescuentosPorVolumenDataset(SerializationInfo info, StreamingContext context) {
        ...
        public override DataSet Clone() {
            tsa_DescuentosPorVolumenDataset cln = ((tsa_DescuentosPorVolumenDataset)(base.Clone()));
            cln.InitVars();
            return cln;
        }
        ...
        private void InitClass() {
            this.DataSetName = "tsa_DescuentosPorVolumenDataset";
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/tsa_DescuentosPorVolumen.xsd";
        ...
        public class tsa_DescuentosPorVolumenDataTable : DataTable, System.Collections.IEnumerable {
            ...
            private void InitClass() {
                ...
                this.Constraints.Add(new UniqueConstraint("tsa_DescuentosPorVolumenKey1", new DataColumn[] {
