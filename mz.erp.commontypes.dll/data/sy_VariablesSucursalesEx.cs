...
namespace mz.erp.commontypes.data {
    ...
    public class sy_VariablesSucursalesExDataset : DataSet {
        
        private sy_VariablesSucursalesDataTable tablesy_VariablesSucursales;
        
        public sy_VariablesSucursalesExDataset() {
            this.InitClass();
        ...
        protected sy_VariablesSucursalesExDataset(SerializationInfo info, StreamingContext context) {
        ...
        public override DataSet Clone() {
            sy_VariablesSucursalesExDataset cln = ((sy_VariablesSucursalesExDataset)(base.Clone()));
            cln.InitVars();
            return cln;
        }
        ...
        private void InitClass() {
            this.DataSetName = "sy_VariablesSucursalesExDataset";
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/sy_VariablesSucursalesEx.xsd";
        ...
        public class sy_VariablesSucursalesDataTable : DataTable, System.Collections.IEnumerable {
            ...
            private void InitClass() {
                ...
                this.Constraints.Add(new UniqueConstraint("sy_VariablesSucursalesExDatasetKey1", new DataColumn[] {
