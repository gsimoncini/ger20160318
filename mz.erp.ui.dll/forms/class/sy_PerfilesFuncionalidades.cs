namespace mz.erp.ui.forms.classes
{
	...
	public class sy_PerfilesFuncionalidades : IDisposable, IGridDocument
	{
		...
		public string GetLayout()
		{
			...
			returnValue += @"<Column1 ID=""IdFuncionalidad""><Caption>IdFuncionalidad</Caption><DataMember>IdFuncionalidad</DataMember><Key>IdFuncionalidad</Key><Position>1</Position></Column1>";
		...
		{
			return mz.erp.businessrules.sy_PerfilesFuncionalidades.GetList().sy_PerfilesFuncionalidades;
		}
		
		public void Update( object dataTable )
		{
			mz.erp.businessrules.sy_PerfilesFuncionalidades.Update( ( sy_PerfilesFuncionalidadesDataset.sy_PerfilesFuncionalidadesDataTable )dataTable );
		}
