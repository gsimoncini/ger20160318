namespace mz.erp.ui
{
	...
	public class tlg_OrdenesPreparacionDet : IDisposable, IGridDocument
	{
		...
		public string GetLayout()
		{
			...
			returnValue += @"<Column3 ID=""Preparado""><Caption>Preparado</Caption><DataMember>Preparado</DataMember><Key>Preparado</Key><Position>3</Position></Column3>";
			returnValue += @"<Column4 ID=""Controlador""><Caption>Controlador</Caption><DataMember>Controlador</DataMember><Key>Controlador</Key><Position>4</Position></Column4>";
			returnValue += @"<Column5 ID=""Lote""><Caption>Lote</Caption><DataMember>Lote</DataMember><Key>Lote</Key><Position>5</Position></Column5>";
		...
		{
			return mz.erp.businessrules.tlg_OrdenesPreparacionDet.GetList().tlg_OrdenesPreparacionDet;
		}
		
		public void Update( object dataTable )
		{
			mz.erp.businessrules.tlg_OrdenesPreparacionDet.Update( ( tlg_OrdenesPreparacionDetDataset.tlg_OrdenesPreparacionDetDataTable )dataTable );
		}
