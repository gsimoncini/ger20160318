	...
	public class tlg_Depositos : IDisposable, IGridDocument
	{
		...
		public string GetLayout()
		{
			...
			*/
            ...
            //Fin German 20100907 - Tarea 826
			/*
            if ( fl.Contains( "OldIdDeposito" ) || _fieldList == null ) sb.Append( LayoutBuilder.GetRow( i++, "OldIdDeposito", "OldIdDeposito",true ) );
             */
