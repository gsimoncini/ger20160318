namespace mz.erp.ui
{
	...
	public class tsa_DescuentosPorVolumen : IDisposable, IGridDocument
	{
		...
		public string GetLayout()
		{
			...
			returnValue += @"<Column3 ID=""Unidades""><Caption>Unidades</Caption><DataMember>Unidades</DataMember><Key>Unidades</Key><Position>3</Position></Column3>";
		...
		{
			return mz.erp.businessrules.tsa_DescuentosPorVolumen.GetList().tsa_DescuentosPorVolumen;
		}
		
		public void Update( object dataTable )
		{
			mz.erp.businessrules.tsa_DescuentosPorVolumen.Update( ( tsa_DescuentosPorVolumenDataset.tsa_DescuentosPorVolumenDataTable )dataTable );
		}
