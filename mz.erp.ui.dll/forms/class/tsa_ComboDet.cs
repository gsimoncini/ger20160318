namespace mz.erp.ui
{
	...
	public class tsa_ComboDet : IDisposable, IGridDocument
	{
		public tsa_ComboDet()
		{
		}
		...
		public string GetLayout()
		{
			...
			returnValue += @"<Column4 ID=""Orden""><Caption>Orden</Caption><DataMember>Orden</DataMember><Key>Orden</Key><Position>4</Position></Column4>";
		...
		{
			return mz.erp.businessrules.tsa_ComboDet.GetList().tsa_ComboDet;
		}
		
		public void Update( object dataTable )
		{
			mz.erp.businessrules.tsa_ComboDet.Update( ( tsa_ComboDetDataset.tsa_ComboDetDataTable )dataTable );
		}
