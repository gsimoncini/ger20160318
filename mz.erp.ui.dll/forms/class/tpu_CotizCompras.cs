namespace mz.erp.ui.forms.classes
{
	...
	public class tpu_CotizCompras : IDisposable, IGridDocument
	{
		...
		public string GetLayout()
		{
			...
			returnValue += @"<Column3 ID=""FechaConfirmacion""><Caption>FechaConfirmacion</Caption><DataMember>FechaConfirmacion</DataMember><Key>FechaConfirmacion</Key><Position>3</Position></Column3>";
			returnValue += @"<Column4 ID=""FechaRespuesta""><Caption>FechaRespuesta</Caption><DataMember>FechaRespuesta</DataMember><Key>FechaRespuesta</Key><Position>4</Position></Column4>";
			...
			returnValue += @"<Column6 ID=""Descripcion""><Caption>Descripcion</Caption><DataMember>Descripcion</DataMember><Key>Descripcion</Key><Position>6</Position></Column6>";
			returnValue += @"<Column7 ID=""IdProveedor""><Caption>IdProveedor</Caption><DataMember>IdProveedor</DataMember><Key>IdProveedor</Key><Position>7</Position></Column7>";
			returnValue += @"<Column8 ID=""Estado""><Caption>Estado</Caption><DataMember>Estado</DataMember><Key>Estado</Key><Position>8</Position></Column8>";
		...
		{
			return mz.erp.businessrules.tpu_CotizCompras.GetList().tpu_CotizCompras;
		}
		
		public void Update( object dataTable )
		{
			mz.erp.businessrules.tpu_CotizCompras.Update( ( tpu_CotizComprasDataset.tpu_CotizComprasDataTable )dataTable );
		}
