namespace mz.erp.ui.forms.classes
{
	...
	public class tsa_Cuentas : IDisposable, IGridDocument
	{
		...
		[ SearchMember( "tsa_Cuentas", Caption ="Cuentas", 
				CaptionHint = "Nombre, Domicilio, Télefono, Tipo de documento, Número de documento, Titular", 
				Hint = "Nombre, Domicilio, Telefono, IdTipoDocumento, Documento, IdTitular") ]
			...
			)
		{
			...
			if(Variables.GetValueBool("Cuentas.Busquedas.BusquedaParcial"))
                data = mz.erp.businessrules.tsa_Cuentas.GetList( Codigo, Nombre, null, idTipoDocumento, Documento, IdTitular, Activo);
			else

				data = mz.erp.businessrules.tsa_Cuentas.GetListEx( Codigo, Nombre, null, idTipoDocumento, Documento, IdTitular, Activo);
