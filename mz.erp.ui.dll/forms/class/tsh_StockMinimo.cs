namespace mz.erp.ui
{
	...
	public class tsh_StockMinimo : IDisposable, IGridDocument
	{
		...
		public string GetLayout()
		{
			...
			returnValue += @"<Column1 ID=""IdDeposito""><Caption>IdDeposito</Caption><DataMember>IdDeposito</DataMember><Key>IdDeposito</Key><Position>1</Position></Column1>";
		...
		{
			return mz.erp.businessrules.tsh_StockMinimo.GetList().tsh_StockMinimo;
		}
		
		public void Update( object dataTable )
		{
			mz.erp.businessrules.tsh_StockMinimo.Update( ( tsh_StockMinimoDataset.tsh_StockMinimoDataTable )dataTable );
		}
