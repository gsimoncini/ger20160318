namespace mz.erp.ui
{
	...
	public class tsa_CotizacionesDet : IDisposable, IGridDocument
	{
		...
		public string GetLayout()
		{
			...
			returnValue += @"<Column4 ID=""PrecioFinal""><Caption>PrecioFinal</Caption><DataMember>PrecioFinal</DataMember><Key>PrecioFinal</Key><Position>4</Position></Column4>";
			returnValue += @"<Column5 ID=""IdMoneda""><Caption>IdMoneda</Caption><DataMember>IdMoneda</DataMember><Key>IdMoneda</Key><Position>5</Position></Column5>";
			returnValue += @"<Column6 ID=""IdFuenteDeCambio""><Caption>IdFuenteDeCambio</Caption><DataMember>IdFuenteDeCambio</DataMember><Key>IdFuenteDeCambio</Key><Position>6</Position></Column6>";
		...
		{
			return mz.erp.businessrules.tsa_CotizacionesDet.GetList().tsa_CotizacionesDet;
		}
		
		public void Update( object dataTable )
		{
			mz.erp.businessrules.tsa_CotizacionesDet.Update( ( tsa_CotizacionesDetDataset.tsa_CotizacionesDetDataTable )dataTable );
		}
