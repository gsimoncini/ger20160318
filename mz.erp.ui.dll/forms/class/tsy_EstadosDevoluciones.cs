namespace mz.erp.ui
{
	...
	public class tsy_EstadosDevoluciones : IDisposable, IGridDocument
	{
		...
		public string GetLayout()
		{
			...
			returnValue += @"<Column0 ID=""IdEstadoDevolucion""><Caption>IdEstadoDevolucion</Caption><DataMember>IdEstadoDevolucion</DataMember><Key>IdEstadoDevolucion</Key><Position>0</Position></Column0>";
		...
		{
			return mz.erp.businessrules.tsy_EstadosDevoluciones.GetList().tsy_EstadosDevoluciones;
		}
		
		public void Update( object dataTable )
		{
			mz.erp.businessrules.tsy_EstadosDevoluciones.Update( ( tsy_EstadosDevolucionesDataset.tsy_EstadosDevolucionesDataTable )dataTable );
		}
