namespace mz.erp.ui.forms.classes
{
	...
	public class sy_TiposRecursos : IDisposable, IGridDocument
	{
		...
		public string GetLayout()
		{
			...
			returnValue += @"<Column0 ID=""IdTipoRecurso""><Caption>IdTipoRecurso</Caption><DataMember>IdTipoRecurso</DataMember><Key>IdTipoRecurso</Key><Position>0</Position></Column0>";
		...
		{
			return mz.erp.businessrules.sy_TiposRecursos.GetList().sy_TiposRecursos;
		}
		
		public void Update( object dataTable )
		{
			mz.erp.businessrules.sy_TiposRecursos.Update( ( sy_TiposRecursosDataset.sy_TiposRecursosDataTable )dataTable );
		}
