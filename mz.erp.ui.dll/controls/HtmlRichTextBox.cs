...
namespace HtmlRichText
{
	...
	{ 
		...
		private bool _addToFinal = false;
		...
		public void AddHTML(string strHTML, bool AddToFinal) 
		{
			_addToFinal = AddToFinal;
			AddHTML(strHTML);
		}
		public void AddHTML(string strHTML)
		{
			...
			{
				string strEnter = "<br>";
				strHTML = strHTML.Replace(strEnter.ToLower(), "\r\n");
				strHTML = strHTML.Replace(strEnter.ToUpper(), "\r\n");
				// process text
